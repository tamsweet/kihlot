...
class Course extends Model
{
    ...
    protected $fillable = [
        'category_id','childcategory_id','subcategory_id', 'language_id', 'user_id', 'title','short_detail', 'detail',  'price', 'discount_price','day','video', 'video_url', 'featured','requirement','url','slug','status','preview_image', 'type', 'preview_type', 'duration', 'duration_type', 'instructor_revenue', 'involvement_request', 'refund_enable', 'refund_policy_id'
    ];
