                ...
                <div class="box box-primary">
                    ...
                    <div class="panel-body">
                        <form id="demo-form2" method="post" action="{{action('BlogController@store')}}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="date">{{ __('adminstaticword.Date') }}:<sup
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" type="text" name="heading"
                                           placeholder="Please Enter Your Heading" required>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="box-footer">
                                <button type="submit" value="Add Blog" class="btn btn-lg col-md-3 btn-primary">
