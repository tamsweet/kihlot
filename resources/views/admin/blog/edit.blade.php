                ...
                <div class="box box-primary">
                    ...
                    <div class="panel-body">
                        <form action="{{route('blog.update',$show->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="image">{{ __('adminstaticword.Date') }}<sup
                                            class="redstar">*</sup></label>
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input value="{{ $show->date }}" id="datepicker" autofocus required
                                               name="heading" type="text" class="form-control"
                                               placeholder="select date"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label for="heading">{{ __('adminstaticword.User') }}<sup
                                            class="redstar">*</sup></label>
                                    <select name="user_id"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input value="{{ $show->heading }}" autofocus required name="heading" type="text"
                                           class="form-control" placeholder="Enter Heading"/>
                                </div>
                                <div class="col-md-6">
                                    <label for="text">{{ __('adminstaticword.ButtonText') }}</label>
                                    <input value="{{ $show->text }}" autofocus name="text" type="text"
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <textarea name="detail" rows="5" class="form-control"
                                              placeholder="Enter Your Details">{{ $show->detail }}</textarea>
                                </div>
                                <div class="col-md-3">
                                    <label for="image">{{ __('adminstaticword.Image') }}<sup
                                            class="redstar">*</sup></label>
                                    <input type="file" name="image" id="image"><br><img
                                        src="{{ url('/images/blog/'.$show->image) }}" class="img-responsive"/>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="approved" type="checkbox"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="status" type="checkbox"
                                               name="status" {{ $show->status == '1' ? 'checked' : '' }} >
                                        <label class="tgl-btn" data-tg-off="Disable" data-tg-on="Enable"
                                               for="status"></label>
                                    </li>
