                            ...
                            <form action="{{route('bundle.update',$cor->id)}}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-single" name="course_id[]"
                                        ...
                                        @foreach ($courses as $cat)
                                            @if($cat->status == 1)
                                                <option
                                                    value="{{ $cat->id }}" {{in_array($cat->id, $cor['course_id'] ?: []) ? "selected": ""}}>{{ $cat->title }}
                                                </option>
                                            @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <label for="exampleInputDetails">{{ __('adminstaticword.Detail') }}:<sup
                                                class="redstar">*</sup></label>
                                        <textarea id="editor2" name="detail" rows="3" class="form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div @if($cor->price =="" && $cor->price =="") class="display-none"
                                             @endif id="doabox">
