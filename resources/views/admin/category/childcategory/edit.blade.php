                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select name="category_id" id="category_id"
                                            ...
                                            @foreach($category as $caat)
                                                <option
                                                    {{ $cate->category_id == $caat->id ? 'selected' : "" }} value="{{ $caat->id }}">{{ $caat->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select name="subcategory_id" id="upload_id"
                                            ...
                                            @foreach($subcategory as $caat)
                                                <option
                                                    {{ $cate->subcategory_id == $caat->id ? 'selected' : "" }} value="{{ $caat->id }}">{{ $caat->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control icp-auto icp" name="icon"
                                               id="exampleInputTitle" value="{{$cate->icon}}">
                                    </div>
                                </div>
                                <br>
