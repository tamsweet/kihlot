            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a href="{{url('childcategory/create')}}"
                           class="btn btn-info btn-sm">+ {{ __('adminstaticword.AddChildCategory') }}</a>
                    </div>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($childcategory as $cat)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-sm" href="{{url('childcategory/'.$cat->id)}}"><i
                                                    class="glyphicon glyphicon-pencil"></i></a>
                                        </td>
                                        <td>
                                            <form method="post" action="{{url('childcategory/'.$cat->id)}}"
