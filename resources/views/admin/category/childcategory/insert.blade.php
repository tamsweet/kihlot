                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <button type="button" data-dismiss="modal" data-toggle="modal"
                                                ...
                                                class="btn btn-md btn-primary">{{ __('adminstaticword.Add') }}</button>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="title" id="exampleInputTitle"
                                               placeholder="Enter your childcategory" value="">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control icp-auto icp" name="icon"
                                               id="exampleInputTitle" placeholder="Enter your icon" value="">
                                    </div>
                                </div>
                                <br>
