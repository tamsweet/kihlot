                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="panel-heading">
                            <a href=" {{url('admin/country')}} "
                               class="btn btn-success pull-right owtbtn">< {{ __('adminstaticword.Back') }}</a>
                        </div>

                        <form id="demo-form2" method="post" enctype="multipart/form-data"
                              action="{{url('admin/country')}}" data-parsley-validate
                              class="form-horizontal form-label-left">
                            {{csrf_field()}}

                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                       for="first-name">{{ __('adminstaticword.Country') }} <span
