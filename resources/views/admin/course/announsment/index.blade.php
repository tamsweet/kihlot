<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <a data-toggle="modal" data-target="#myModalabcdef" href="#"
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($cor->announsment as $an)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-success btn-sm" href="{{url('announsment/'.$an->id)}}"><i
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"
                        id="myModalLabel">{{ __('adminstaticword.Add') }}{{ __('adminstaticword.Announcement') }}</h4>
                </div>
                    ...
                    <div class="panel panel-sum">
                        <div class="modal-body">
                            <form id="demo-form2" method="post" action="{{ route('announsment.store') }}"
                                ...
                                <label class="display-none" for="exampleInputSlug"> {{ __('adminstaticword.Course') }}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="exampleInputDetails">{{ __('adminstaticword.Announcement') }}:<sup
