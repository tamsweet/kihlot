<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <a data-toggle="modal" data-target="#myModalanswer" href="#"
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($answers as $ans)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm" href="{{route('courseanswer.edit',$ans->id)}}"><i
                                        class="glyphicon glyphicon-pencil"></i></a>
                            </td>

                            <td>
                                <form method="post" action="{{url('courseanswer/'.$ans->id)}}
                    ...
                    <div class="panel panel-sum">
                        <div class="modal-body">
                            <form id="demo-form2" method="post" action="{{url('courseanswer/')}}" data-parsley-validate
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="exampleInputTit1e">{{ __('adminstaticword.SelectQuestion') }}:<sup
                                                class="redstar">*</sup></label>
                                        <br>
                                        <select style="width: 100%" name="question_id" required
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="exampleInput">{{ __('adminstaticword.Answer') }}:<sup
                                                class="redstar">*</sup></label>
