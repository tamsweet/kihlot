                ...
                <div class="box box-primary">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="instructor-detail">
                                <ul>
                                    ...
                                    <li>{{ __('adminstaticword.User') }}
                                        : {{ $appoint->user->fname }} {{ $appoint->user->lname }}</li>
                        ...
                        <form action="{{route('appointment.update',$appoint->id)}}" method="POST"
                            ...
                            <input type="hidden" value="{{ $appoint->course_id }}" name="course_id"
                                   class="form-control">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="appoint_accept" type="checkbox"
                                               name="accept" {{ $appoint->accept == 1 ? 'checked' : '' }} >
                                        <label class="tgl-btn" data-tg-off="Disable" data-tg-on="Enable"
                                               for="appoint_accept"></label>
                                    </li>
                                </div>
                            </div>
                            <br>

                            <div class="row" style="{{ $appoint['accept'] == '1' ? '' : 'display:none' }}"
                                 id="sec1_one">
                                <div class="col-md-12">
