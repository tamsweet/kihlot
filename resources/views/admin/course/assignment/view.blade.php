                            ...
                            <div class="instructor-detail">
                                <ul>
                                    ...
                                    <li>{{ __('adminstaticword.User') }}
                                        : {{ $assign->user->fname }} {{ $assign->user->lname }}</li>
                                    <li>{{ __('adminstaticword.Course') }}: {{ $assign->courses->title }}</li>
                                    <li>{{ __('adminstaticword.CourseChapter') }}
                                        : {{ $assign->chapter->chapter_name }}</li>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="assign_accept" type="checkbox"
                                               name="type" {{ $assign->type == 1 ? 'checked' : '' }} >
                                        <label class="tgl-btn" data-tg-off="Unchecked" data-tg-on="Checked"
                                               for="assign_accept"></label>
                                    </li>
                                </div>
                            </div>
                            <br>
