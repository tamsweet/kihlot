<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <a data-toggle="modal" data-target="#myModalJ" href="#"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"
                        id="myModalLabel">{{ __('adminstaticword.Add') }} {{ __('adminstaticword.CourseInclude') }}</h4>
                </div>
                    ...
                    <div class="panel panel-sum">
                        <div class="modal-body">
                            <form id="demo-form2" method="post" action="{{ route('courseinclude.store') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="">{{ __('adminstaticword.Icon') }}:<sup
                                                class="redstar">*</sup></label>
                                        <input type="text" name="icon" class="form-control icp-auto icp"
