                    ...
                    <form action="{{route('course.update',$cor->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="category_id" id="category_id" class="form-control js-example-basic-single"
                                    ...
                                    @foreach($category as $caat)
                                        <option
                                            {{ $cor->category_id == $caat->id ? 'selected' : "" }} value="{{ $caat->id }}">{{ $caat->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3">
                                ...
                                <select name="subcategory_id" id="upload_id"
                                    ...
                                    @foreach($subcategory as $caat)
                                        <option
                                            {{ $cor->subcategory_id == $caat->id ? 'selected' : "" }} value="{{ $caat->id }}">{{ $caat->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3">
                                ...
                                <select name="childcategory_id" id="grand" class="form-control js-example-basic-single">
                                    ...
                                    @foreach($childcategory as $caat)
                                        <option
                                            {{ $cor->childcategory_id == $caat->id ? 'selected' : "" }} value="{{ $caat->id }}">{{ $caat->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="language_id"
                                    ...
                                    @foreach($languages as $cat)
                                        <option
                                            {{ $cor->language_id == $cat->id ? 'selected' : "" }} value="{{ $cat->id }}">{{ $cat->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 display-none">
                                ...
                                <li class="tg-list-item">
                                    <input class="tgl tgl-skewed" id="rox" type="checkbox"
                                           @if($cor->day !="" && $cor->day !="") checked @endif/>
                            ...
                            <div class="col-md-3">
                                ...
                                <li class="tg-list-item">
                                    <input class="tgl tgl-skewed" id="cb111" name="type"
                                           type="checkbox" {{ $cor->type == '1' ? 'checked' : '' }}/>
                                ...
                                @if(Auth::User()->role == "admin")
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="cb1"
                                               type="checkbox"{{ $cor->featured==1 ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3">
                                @if(Auth::User()->role == "admin")
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="cb333"
                                               type="checkbox" {{ $cor->status==1 ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-3">
                                ...
                                <li class="tg-list-item">
                                    <input name="involvement_request" class="tgl tgl-skewed" id="involve"
                                           type="checkbox" {{ $cor->involvement_request==1 ? 'checked' : '' }}/>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <li class="tg-list-item">
                                    <input name="preview_type" class="tgl tgl-skewed" id="preview"
                                           type="checkbox" {{ $cor->preview_type=="video" ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <li class="tg-list-item">
                                    <input class="tgl tgl-skewed" id="duration_type" type="checkbox"
                                ...
                                <input min="1" class="form-control" name="duration" type="number" id="duration"
                                       value="{{ $cor->duration }}" placeholder="Enter Duration in months">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <label for="image">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="7" viewBox="0 0 20 17">
                                        <path
