                                ...
                                <div>
                                    <h4 class="admin-form-text"><a href="{{url('course')}}" data-toggle="tooltip"
                                                ...
                                                <button class="btn btn-xs btn-success abc">
                                                    << {{ __('adminstaticword.Back') }}</button>
                                            </i></a></h4>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select name="language_id" class="form-control js-example-basic-single">
                                            ...
                                            @foreach($languages as $caat)
                                                <option
                                                    {{ $caat->language_id == $caat->id ? 'selected' : "" }} value="{{ $caat->id }}">{{ $caat->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="title" class="form-control" name="title" id="exampleInputTitle"
                                               placeholder="Please Enter Your Title" value="" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="exampleInputSlug">{{ __('adminstaticword.Slug') }}: <sup
                                                class="redstar">*</sup></label>
                                        <input pattern="[/^\S*$/]+" type="text" class="form-control" name="slug"
                                               id="exampleInputPassword1" placeholder="Please Enter Your Slug" required>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <li class="tg-list-item">
                                            ...
                                            <label class="tgl-btn" data-tg-off="Free" data-tg-on="Paid"
                                                   for="cb111"></label>
                                        </li>
                                        <br>
                                        <div class="display-none" id="pricebox">
                                            ...
                                            <input type="text" class="form-control" name="price" id="priceMain"
                                                   placeholder="Please Your Enter price" value="">

                                            <label for="exampleInputSlug">{{ __('adminstaticword.DiscountPrice') }}
                                                : </label>
                                            <input type="text" class="form-control" name="discount_price"
                                                   id="offerPrice" placeholder="Please Your Enter discount_price"
                                                   value="">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        @if(Auth::User()->role == "admin")
                                            <label for="exampleInputDetails">{{ __('adminstaticword.Featured') }}
                                                :</label>
                                            <li class="tg-list-item">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <label for="exampleInputDetails">{{ __('adminstaticword.InvolvementRequest') }}
                                            :</label>
                                        <li class="tg-list-item">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="display-none" id="document1">
                                            <label for="exampleInputSlug">{{ __('adminstaticword.UploadVideo') }}
                                                :</label>
                                        ...
                                        @if(Auth::User()->role == "admin")
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input min="1" max="100" class="form-control" name="instructor_revenue"
                                                       type="number" id="revenue" placeholder="Enter revenue percentage"
