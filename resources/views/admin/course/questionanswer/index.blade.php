<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <a data-toggle="modal" data-target="#myModalabcde" href="#"
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('ansr.quick',$que->id) }}" method="POST">
                                    {{ csrf_field() }}
                                    <button type="Submit"
                                            class="btn btn-xs {{ $que->status ==1 ? 'btn-success' : 'btn-danger' }}">
                                        @if($que->status ==1)
                            ...
                            <td>
                                <a class="btn btn-success btn-sm" href="{{url('questionanswer/'.$que->id)}}"><i
