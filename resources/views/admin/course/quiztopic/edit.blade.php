                    ...
                    <div class="panel-body">
                        ...
                        <form id="demo-form2" method="POST" action="{{route('quiztopic.update', $topic->id)}}"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" placeholder="Enter Quiz Topic" class="form-control " name="title"
                                           id="exampleInputTitle" value="{{ $topic->title }}">
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" placeholder="Enter Due Days" class="form-control" name="due_days"
                                           id="exampleInputTitle" value="{{ $topic->due_days }}">
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="111" type="checkbox"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="112" type="checkbox"
                            ...
                            <div class="box-footer">
                                <button type="submit" value="Add Answer"
