                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <form id="demo-form" method="post" action="{{url('reviewrating/'.$jp->id)}}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="display-none"
                                               for="exampleInputSlug">{{ __('adminstaticword.Course') }}</label>
                                        <select name="course" class="form-control col-md-7 col-xs-12 display-none">
                                            @foreach($courses as $cou)
                                                <option
                                                    value="{{ $cou->id }}" {{$jp->courses->id == $cou->id  ? 'selected' : ''}}>{{ $cou->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="display-none"
                                               for="exampleInputSlug">{{ __('adminstaticword.User') }}</label>
                                        <select name="user" class="form-control col-md-7 col-xs-12 display-none">
                                            @foreach($users as $cu)
                                                <option
                                                    value="{{ $cu->id }}" {{$jp->user->id == $cu->id  ? 'selected' : ''}}>{{ $cu->fname}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="Details">{{ __('adminstaticword.Review') }}:<sup
                                                class="redstar">*</sup></label>
                                        <textarea rows="3" name="review" class="form-control"
                                                  placeholder="Enter Your review">{{ $jp->review }}</textarea>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-skewed" id="abcde"
                                                   type="checkbox" {{ $jp->status==1 ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-skewed" id="cb10112"
                                                   type="checkbox" {{ $jp->approved==1 ? 'checked' : '' }}>
                                            <label class="tgl-btn" data-tg-off="Deactive" data-tg-on="Active"
                                                   for="cb10112"></label>
                                        </li>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-skewed" id="featured1"
                                                   type="checkbox" {{ $jp->featured==1 ? 'checked' : '' }}>
                                            <label class="tgl-btn" data-tg-off="Deactive" data-tg-on="Active"
                                                   for="featured1"></label>
                                        </li>
