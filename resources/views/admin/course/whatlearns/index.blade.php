...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <a data-toggle="modal" data-target="#myModaljj" href="#"
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($whatlearns as $cat)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-success btn-sm" href="{{url('whatlearns/'.$cat->id)}}"><i
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"
                        id="myModalLabel"> {{ __('adminstaticword.Add') }} {{ __('adminstaticword.WhatLearns') }}</h4>
                </div>
                        ...
                        <div class="modal-body">
                            <form id="demo-form2" method="post" action="{{ route('whatlearns.store') }}"
                                ...
                                <select name="course_id" class="form-control display-none">
                                    <option class="display-none" name="course_id"
                                            value="{{ $cor->id }}">{{ $cor->title }}</option>
                                </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <textarea rows="1" name="detail" class="form-control"
