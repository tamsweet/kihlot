                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" class="form-control" name="name"
                                               value="{{ $language->name }}" id="exampleInputPassword1"
                                               placeholder="Please Enter Your  Language Name">
                                    </div>

                                    <div class="col-md-3">
                                        <label for="exampleInputTit1e">{{ __('adminstaticword.Status') }}:</label>
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-skewed" id="xyz"
                                                   type="checkbox" {{ $language->status==1 ? 'checked' : '' }}>
