            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a data-toggle="modal" data-target="#myModaljjh" href="#"
                                ...
                                @foreach($language as $cat)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if(Auth::user()->role == "admin")
                                                <a class="btn btn-success btn-sm"
                                                   href="{{url('courselang/'.$cat->id.'/edit')}}"><i
                                                        class="glyphicon glyphicon-pencil"></i></a>
                                            @else
                                                <a type="submit" class="btn btn-success btn-sm" data-toggle="tooltip"
                                                   rel="tooltip" data-placement="top" disabled="disabled"
                                                   title="Disabled"><i class="glyphicon glyphicon-pencil"></i></a>
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <a type="submit" class="btn btn-danger btn-sm" data-toggle="tooltip"
                                                   rel="tooltip" data-placement="top" disabled="disabled"
                                                   title="Disabled"><i class="fa fa-fw fa-trash-o"></i></a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title"
                                    id="myModalLabel">{{ __('adminstaticword.Add') }} {{ __('adminstaticword.Language') }}</h4>
                            </div>
                            <div class="box box-primary">
                                <div class="panel panel-sum">
                                    <div class="modal-body">
                                        <form id="demo-form2" method="post" action="{{ route('courselang.store') }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label for="exampleInputSlug">{{ __('adminstaticword.Name') }}:<sup
                                                            class="redstar">*</sup></label>
                                                    <input type="text" class="form-control" name="name"
                                                           id="exampleInputPassword1"
                                                           placeholder="Please Enter Your  Language Name" value="">
                                                </div>
                                                <div class="col-md-6">
