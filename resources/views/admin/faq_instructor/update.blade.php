                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <form id="demo-form2" method="post" action="{{url('faqinstructor/'.$find->id)}}"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="exampleInputName">{{ __('adminstaticword.Title') }}:<sup
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-skewed" id="status" type="checkbox"
                                                   name="status" {{ $find->status == '1' ? 'checked' : '' }} >
