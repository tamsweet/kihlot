                        ...
                        <form action="{{ action('GetstartedController@update') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input value="{{ $show['heading'] }}" autofocus name="heading" type="text"
                                           class="form-control" placeholder="Enter Heading"/>
                                </div>
                                <div class="col-md-6">
                                    <label for="sub_heading">{{ __('adminstaticword.SubHeading') }}</label>
                                    <input value="{{ $show['sub_heading'] }}" autofocus name="sub_heading" type="text"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input value="{{ $show['button_txt'] }}" autofocus name="button_txt" type="text"
                                           class="form-control" placeholder="Enter Button Text"/>
                                </div>

                                <div class="col-md-6">
                                    <label for="button_txt">{{ __('adminstaticword.ButtonLink') }}</label>
                                    <input value="{{ $show['link'] }}" name="link" type="text" class="form-control"
