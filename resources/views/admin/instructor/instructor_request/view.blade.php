                    ...
                    <div class="panel-body">
                        ...
                        <div class="view-instructor">
                            <div class="instructor-detail">
                                <ul>
                                    <li><img src="{{ asset('images/instructor/'.$show->image) }}" class="img-circle"/>
                                    </li>
                                    ...
                                    <li>{{ __('adminstaticword.Resume') }}: <a
                        ...
                        <form action="{{route('requestinstructor.update',$show->id)}}" method="POST"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="cb333"
                                               type="checkbox" {{ $show->status==1 ? 'checked' : '' }}>
                                        <label class="tgl-btn" data-tg-off="Pending" data-tg-on="Approved"
                                               for="cb333"></label>
                                    </li>
