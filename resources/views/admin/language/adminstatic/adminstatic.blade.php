            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Admin Static Word Translation of {{ $findlang->name }}
                            ({{ $findlang->local }})</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <form action="{{ route('admin.static.update',$findlang->local) }}" method="POST">
                            ...
                            <textarea name="transfile" class="form-control" id="" cols="100"
                                      rows="20">{{ $file }}</textarea>
                            ...
                            <div class="box-footer">
                                ...
                                <a href="{{ route('show.lang') }}" title="Cancel and go back"
