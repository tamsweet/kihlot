                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs" id="nav-tab" role="tablist">
                                <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab"
                                                                          data-toggle="tab"><i class="fa fa-language"
                                                                                               aria-hidden="true"></i>
                                        Language</a></li>
                                <li role="presentation"><a href="#profile" aria-controls="profile" role="tab"
                                                           data-toggle="tab"><i class="fa fa-laptop"
                                                                                aria-hidden="true"></i> Front Static
                                        Word Translation</a></li>
                                <li role="presentation"><a href="#admin" aria-controls="profile" role="tab"
                                                           data-toggle="tab"><i class="fa fa-laptop"
                                                                                aria-hidden="true"></i> Admin Static
                                        Word Translation</a></li>

                                <li role="presentation"><a href="#flash" aria-controls="flash" role="tab"
                                                           data-toggle="tab"><i class="fa fa-laptop"
                                                                                aria-hidden="true"></i> Flash Message
                                        Translation</a></li>
                            </ul>
