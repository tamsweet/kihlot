                    ...
                    <div class="panel-body">
                        <form action="{{ route('player.update') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-skewed" id="cb4" type="checkbox"
                                                   name="logo_enable" {{ $ps['logo_enable'] == '1' ? 'checked' : '' }} />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputDetails">{{ __('adminstaticword.PlayerLogo') }}</label>-
                                        <p class="inline info">Dimension: 104 x 36</p>
                                        <br>
                                        <input type="file" name="logo" value="{{ $ps['logo'] }}" id="logo"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputDetails">{{ __('adminstaticword.ShareEnable') }}
                                            :</label>
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-skewed" id="cb3" type="checkbox"
                                                   name="share_enable" {{ $ps['share_enable'] == '1' ? 'checked' : '' }} />
                                            <label class="tgl-btn" data-tg-off="Disable" data-tg-on="Enable"
                                                   for="cb3"></label>
                                        </li>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group display-none">
                                        ...
                                        <input value="copyright" name="cpy_text" type="text" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-skewed" id="cb6" type="checkbox"
                                                   name="autoplay" {{ $ps['autoplay'] == '1' ? 'checked' : '' }} />
                                            <label class="tgl-btn" data-tg-off="Disable" data-tg-on="Enable"
                                                   for="cb6"></label>
                                        </li>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-skewed" id="cb7" type="checkbox"
                                                   name="download" {{ $ps['download'] == '1' ? 'checked' : '' }} />
                                            <label class="tgl-btn" data-tg-off="Disable" data-tg-on="Enable"
                                                   for="cb7"></label>
                                        </li>
