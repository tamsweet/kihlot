            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> {{ __('adminstaticword.OrderId') }}
                            - {!! $refunds->order->order_id !!}</h3>
                    </div>
                    <div class="box-body">
                            ...
                            <div class="instructor-detail">
                                <ul>
                                    <li><img src="{{ asset('images/course/'.$refunds->courses->preview_image) }}"
                                             class="img-circle"/></li>
                                    <li>{{ __('adminstaticword.User') }}
                                        : {{ $refunds->user->fname }} {{ $refunds->user->lname }}</li>
                                    ...
                                    <li>{{ __('adminstaticword.TotalAmount') }}: <i
                                            class="{{ $refunds['currency_icon'] }}"></i>{{ $refunds->total_amount }}
                                    </li>
                            ...
                            <form id="demo-form2" method="post" action="{{url('refundorder/'.$refunds->id)}}"
                                ...
                                @if( $refunds->status==0)
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <li class="tg-list-item">
                                                <input class="tgl tgl-skewed" id="cb10"
                                                       type="checkbox" {{ $refunds->status==1 ? 'checked' : '' }}>
                                                <label class="tgl-btn" data-tg-off="Pending" data-tg-on="Accept"
                                                       for="cb10"></label>
                                            </li>
                                    ...
                                    <div class="box-footer">
                                        <button type="submit"
                                                class="btn btn-md col-md-2 btn-primary">{{ __('adminstaticword.ProceedRefund') }}</button>
                                    </div>
                                @endif
                            </form>
                        </div>
