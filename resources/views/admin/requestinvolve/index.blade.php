                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title">Involve Request for
                                                                                Instructor </h4>
                                                                                        ...
                                                                                        @if(Auth::user()->role == 'admin')
                                                                                            <select
                                                                                                ...
                                                                                                @foreach($instructors as $instructor)
                                                                                                    <option
                                                                                                        value="{{ $instructor->id }}">{{ $instructor->fname }}</option>
                                                                                                @endforeach
                                                                                            </select>
                                                                                        @else
                                                                                            <select
                                                                                                ...
                                                                                                <option
                                                                                                    value="{{Auth::user()->id}}">{{ Auth::user()->fname }}</option>
                                                ...
                                                @else
                                                    ...
                                                    <a class="btn btn-info btn-sm" type="button" data-toggle="modal"
                                                       data-target="#involverequest{{$cat->id}}">
                                                        <i class="glyphicon glyphicon-link"></i></a>
                                                    ...
                                                    <div class="modal" id="involverequest{{$cat->id}}">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{route('involve.store',$cat->id)}}"
                                                                          method="post">
                                                                        @csrf
                                                                        <div class="row">
