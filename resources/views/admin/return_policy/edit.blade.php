                            ...
                            <div class="row">
                                ...
                                <div class="col-md-offset-2 col-md-8">
                                    <form id="demo-form2" method="post" action="{{url('refundpolicy/'.$return->id)}}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="title"
                                                       id="exampleInputTitle" value="{{$return->name}}">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="exampleInputSlug">{{ __('adminstaticword.Days') }}:</label>
                                                <input type="text" class="form-control" name="days"
                                                       id="exampleInputPassword1" value="{{$return->days}}">
                                                <br>
                                            </div>


                                            <div class="col-md-6">
                                                <label for="exampleInputSlug">{{ __('adminstaticword.Amount') }}
                                                    :</label>
                                                <input type="text" class="form-control" name="slug"
                                                       id="exampleInputPassword1" value="{{$return->amount}}">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="exampleInputTit1e">{{ __('adminstaticword.Status') }}
                                                    :</label>
                                                <li class="tg-list-item">
                                                    <input class="tgl tgl-skewed" id="cb10"
                                                           type="checkbox" {{ $return->status==1 ? 'checked' : '' }}>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="exampleInputDetails">{{ __('adminstaticword.Detail') }}
                                                    :</label>
                                                <textarea name="details" rows="5" id="editor2"
                                                          class="form-control">{{$return->detail}}</textarea>
                                            </div>
                                        </div>
                                        <br>
