                            ...
                            <div class="row">
                                ...
                                <div class="col-md-offset-2 col-md-8">
                                    <form id="demo-form2" method="post" action="{{url('refundpolicy/')}}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="name"
                                                       placeholder="Enter your name" id="exampleInputTitle" value="">
                                            </div>

                                            <div class="col-md-6">
                                                <label for="exampleInputTit1e">{{ __('adminstaticword.Amount') }}:<sup
                                                        class="redstar">*</sup></label>
                                                <div class="input-group">
                                                    <input min="1" max="100" type="number" class="form-control"
                                                           name="amount" placeholder="Enter return amount in percentage"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label for="exampleInputTit1e">{{ __('adminstaticword.Days') }}:<sup
                                                        class="redstar">*</sup></label>
                                                <input type="text" class="form-control" name="days"
                                                       placeholder="Enter Return Days" id="exampleInputTitle" value="">
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="exampleInputDetails">{{ __('adminstaticword.Detail') }}:<sup
                                                        class="redstar">*</sup></label>
                                                <textarea name="detail" id="editor2" rows="5" class="form-control"
