            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-header">
                        <a type="button" class="btn btn-danger btn-md" data-toggle="modal" data-target="#bulk_delete">
                            <i class="fa fa-money"></i> {{ __('adminstaticword.PaySelected') }}</a>
                    </div>
                        ...
                        <div class="modal-dialog modal-sm">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer text-center">
                                    ...
                                    <form method="post" action="{{ action('AdminPayoutController@bulk_payout', $id) }}"
                                        ...
                                        <td>
                                            <div class="inline">
                                                <input type="checkbox" form="bulk_delete_form"
                                                       ...
                                                       value="{{$pay->id}}" id="checkbox{{$pay->id}}">
