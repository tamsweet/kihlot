                        ...
                        <form action="{{ route('api.update') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="s_sec1" type="checkbox"
                                               name="stripe_check" {{ $gsetting->stripe_enable==1 ? 'checked' : '' }}/>
                                    ...
                                    <div class="row" style="{{ $gsetting->stripe_enable==1 ? '' : 'display:none' }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input value="{{ $env_files['STRIPE_KEY'] }}" autofocus name="STRIPE_KEY"
                                                   type="text" class="form-control" placeholder="Enter Stripe Key"/>
                                            <br>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="s_secretkey">{{ __('adminstaticword.StripeSecretKey') }}<sup
                                                    class="redstar">*</sup></label>
                                            <input value="{{ $env_files['STRIPE_SECRET'] }}" autofocus
                                                   name="STRIPE_SECRET" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="pay_sec1" type="checkbox"
                                               name="paypal_check" {{ $gsetting->paypal_enable==1 ? 'checked' : '' }}/>
                                    ...
                                    <div class="row" style="{{ $gsetting->paypal_enable==1 ? '' : 'display:none' }}"
                                         id="pay_sec">
                                        <div class="col-md-6">
                                            <label for="pay_cid">{{ __('adminstaticword.PaypalClientID') }}<sup
                                                    class="redstar">*</sup></label>
                                            <input value="{{ $env_files['PAYPAL_CLIENT_ID'] }}" autofocus
                                        ...
                                        <div class="col-md-6">
                                            <label for="pay_sid">{{ __('adminstaticword.PaypalSecretID') }}<sup
                                                    class="redstar">*</sup></label>
                                            <input value="{{ $env_files['PAYPAL_SECRET'] }}" autofocus
                                                   name="PAYPAL_SECRET" type="text" class="form-control"
                                                   placeholder="Enter Paypal Secret ID"/>
                                            <br>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="pay_mode">{{ __('adminstaticword.PaypalMode') }}<sup
                                                    class="redstar">*</sup></label>
                                            <input value="{{ $env_files['PAYPAL_MODE'] }}" autofocus name="PAYPAL_MODE"
                                                   type="text" class="form-control" placeholder="Enter Paypal Mode"/>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="insta_sec1" type="checkbox"
                                               name="instamojo_check" {{ $gsetting->instamojo_enable==1 ? 'checked' : '' }} />
                                        <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON"
                                               for="insta_sec1"></label>
                                    </li>
                                    <br>
                                    <div class="row" style="{{ $gsetting->instamojo_enable==1 ? '' : 'display:none' }}"
                                         id="insta_sec">
                                        <div class="col-md-6">
                                            <label for="pay_cid">{{ __('adminstaticword.InstaMojoApiKey') }}<sup
                                                    class="redstar">*</sup></label>
                                            <input value="{{ $env_files['IM_API_KEY'] }}" autofocus name="IM_API_KEY"
                                        ...
                                        <div class="col-md-6">
                                            <label for="pay_sid">{{ __('adminstaticword.InstaMojoAuthToken') }} <sup
                                                    class="redstar">*</sup></label>
                                            <input value="{{ $env_files['IM_AUTH_TOKEN'] }}" autofocus
                                                   name="IM_AUTH_TOKEN" type="text" class="form-control"
                                                   placeholder="Enter InstaMojo Auth Token"/>
                                            <br>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="pay_mode">{{ __('adminstaticword.InstaMojoURL') }}<sup
                                                    class="redstar">*</sup></label>
                                            <input value="{{ $env_files['IM_URL'] }}" autofocus name="IM_URL"
                                                   type="text" class="form-control" placeholder="Enter InstaMojo Url"/>
                                            <small class="text-muted"><i class="fa fa-question-circle"></i> For Test use
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="razor_sec1" type="checkbox"
                                               name="razor_check" {{ $gsetting->razorpay_enable==1 ? 'checked' : '' }}/>
                                        <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON"
                                               for="razor_sec1"></label>
                                    </li>
                                    ...
                                    <div class="row" style="{{ $gsetting->razorpay_enable==1 ? '' : 'display:none' }}"
                                        ...
                                        <div class="col-md-6">
                                            <label for="RAZORPAY_KEY">{{ __('adminstaticword.RazorpayKey') }}<sup
                                                    class="redstar">*</sup></label>
                                            <input value="{{ $env_files['RAZORPAY_KEY'] }}" autofocus
                                                   name="RAZORPAY_KEY" type="text" class="form-control"
                                                   placeholder="Enter Razorpay Key"/>
                                            <br>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="RAZORPAY_SECRET">{{ __('adminstaticword.RazorpaySecretKey') }}
                                                <sup class="redstar">*</sup></label>
                                            <input value="{{ $env_files['RAZORPAY_SECRET'] }}" autofocus
                                                   name="RAZORPAY_SECRET" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="paystack_sec1" type="checkbox"
                                               name="paystack_check" {{ $gsetting->paystack_enable==1 ? 'checked' : '' }}/>
                                        <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON"
                                               for="paystack_sec1"></label>
                                    </li>
                                    ...
                                    <div class="row" style="{{ $gsetting->paystack_enable==1 ? '' : 'display:none' }}"
                                         id="paystack_sec">
                                        <div class="col-md-6">
                                            <label for="RAZORPAY_KEY">{{ __('adminstaticword.PayStackPublicKey') }}<sup
                                                    class="redstar">*</sup></label>
                                            <input value="{{ $env_files['PAYSTACK_PUBLIC_KEY'] }}" autofocus
                                                   name="PAYSTACK_PUBLIC_KEY" type="text" class="form-control"
                                                   placeholder="Enter Paystack Public Key"/>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="RAZORPAY_SECRET">{{ __('adminstaticword.PayStackSecretKey') }}
                                                <sup class="redstar">*</sup></label>
                                            <input value="{{ $env_files['PAYSTACK_SECRET_KEY'] }}" autofocus
                                        ...
                                        <div class="col-md-6">
                                            <label for="RAZORPAY_KEY">{{ __('adminstaticword.PayStackPaymentUrl') }}<sup
                                                    class="redstar">*</sup></label>
                                            <input value="{{ $env_files['PAYSTACK_PAYMENT_URL'] }}" autofocus
                                                   name="PAYSTACK_PAYMENT_URL" type="text" class="form-control"
                                                   placeholder="Enter Paystack Payment URL"/>
                                            <small class="text-muted"><i class="fa fa-question-circle"></i> use <b>https://api.paystack.co</b>
                                            </small>
                                            <br>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <label
                                                for="RAZORPAY_SECRET">{{ __('adminstaticword.PayStackMerchantEmail') }}
                                                <sup class="redstar">*</sup></label>
                                            <input value="{{ $env_files['PAYSTACK_MERCHANT_EMAIL'] }}" autofocus
                                                   name="PAYSTACK_MERCHANT_EMAIL" type="text" class="form-control"
                                                   placeholder="Enter Paystack Merchant Email"/>
                                            <small class="text-muted"><i class="fa fa-question-circle"></i> use <b>Paystack
                                                    email</b> </small>
                                            <br>
                                            <br>
                                        ...
                                        <div class="col-md-6">
                                            <label for="RAZORPAY_SECRET">{{ __('adminstaticword.PaystackCallbackURL') }}
                                                <sup class="redstar">*</sup></label>
                                            <input value="{{ url('callback') }}" autofocus type="text"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="paytm_sec1" type="checkbox"
                                               name="paytm_check" {{ $gsetting->paytm_enable==1 ? 'checked' : '' }}/>
                                        <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON"
                                               for="paytm_sec1"></label>
                                    </li>
                                    ...
                                    <div class="row" style="{{ $gsetting->paytm_enable==1 ? '' : 'display:none' }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label
                                                    for="PAYTM_ENVIRONMENT">{{ __('adminstaticword.PaytmEnviroment') }}
                                                    <sup class="redstar">*</sup></label>
                                                <small class="text-muted"><i class="fa fa-question-circle"></i> For Test
                                                    use <b>"local"</b> and for Live use <b>"production"</b></small>
                                                <input value="{{ $env_files['PAYTM_ENVIRONMENT'] }}" autofocus
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label
                                                    for="PAYTM_MERCHANT_ID">{{ __('adminstaticword.PaytmMerchantID') }}
                                                    <sup class="redstar">*</sup></label>
                                                <input value="{{ $env_files['PAYTM_MERCHANT_ID'] }}" autofocus
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label
                                                    for="PAYTM_MERCHANT_KEY">{{ __('adminstaticword.PaytmMerchantKey') }}
                                                    <sup class="redstar">*</sup></label>
                                                <input value="{{ $env_files['PAYTM_MERCHANT_KEY'] }}" autofocus
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label
                                                    for="PAYTM_MERCHANT_WEBSITE">{{ __('adminstaticword.PaytmMerchantWebsite') }}
                                                    <sup class="redstar">*</sup></label>
                                                <input value="{{ $env_files['PAYTM_MERCHANT_WEBSITE'] }}" autofocus
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="PAYTM_CHANNEL">{{ __('adminstaticword.PaytmChannel') }}<sup
                                                        class="redstar">*</sup></label>
                                                <input value="{{ $env_files['PAYTM_CHANNEL'] }}" autofocus
                                                       name="PAYTM_CHANNEL" type="text" class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label
                                                    for="PAYTM_INDUSTRY_TYPE">{{ __('adminstaticword.PaytmIndustryType') }}
                                                    <sup class="redstar">*</sup></label>
                                                <input value="{{ $env_files['PAYTM_INDUSTRY_TYPE'] }}" autofocus
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="captcha_sec1" type="checkbox"
                                               name="captcha_check" {{ $gsetting->captcha_enable == 1 ? 'checked' : '' }} >
                                        <label class="tgl-btn" data-tg-off="Disable" data-tg-on="Enable"
                                               for="captcha_sec1"></label>
                                    </li>
                                    ...
                                    <div class="row" style="{{ $gsetting->captcha_enable==1 ? '' : 'display:none' }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="PAYTM_CHANNEL">{{ __('adminstaticword.CaptchaSiteKey') }}
                                                    <sup class="redstar">*</sup></label>
                                                <input value="{{ $env_files['NOCAPTCHA_SITEKEY'] }}" autofocus
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label
                                                    for="PAYTM_INDUSTRY_TYPE">{{ __('adminstaticword.CaptchaSecretKey') }}
                                                    <sup class="redstar">*</sup></label>
                                                <input value="{{ $env_files['NOCAPTCHA_SECRET'] }}" autofocus
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="aws_sec1" type="checkbox"
                                               name="aws_check" {{ $gsetting->aws_enable == 1 ? 'checked' : '' }} >
                                        <label class="tgl-btn" data-tg-off="Disable" data-tg-on="Enable"
                                               for="aws_sec1"></label>
                                    </li>
                                    ...
                                    <div class="row" style="{{ $gsetting->aws_enable==1 ? '' : 'display:none' }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label
                                                    for="AWS_ACCESS_KEY_ID">{{ __('adminstaticword.AWSAccessKeyID') }}
                                                    <sup class="redstar">*</sup></label>
                                                <input value="{{ $env_files['AWS_ACCESS_KEY_ID'] }}" autofocus
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label
                                                    for="AWS_SECRET_ACCESS_KEY">{{ __('adminstaticword.AWSSecretAccessKey') }}
                                                    <sup class="redstar">*</sup></label>
                                                <input value="{{ $env_files['AWS_SECRET_ACCESS_KEY'] }}" autofocus
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label
                                                    for="AWS_DEFAULT_REGION">{{ __('adminstaticword.AWSDefaultRegion') }}
                                                    <sup class="redstar">*</sup></label>
                                                <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top"
                                                   title="eg:ap-south-1"></i>
                                                <input value="{{ $env_files['AWS_DEFAULT_REGION'] }}" autofocus
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="AWS_BUCKET">{{ __('adminstaticword.AWSBucketName') }}<sup
                                                        class="redstar">*</sup></label>
                                                <input value="{{ $env_files['AWS_BUCKET'] }}" autofocus
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $env_files['AWS_URL'] }}" autofocus name="AWS_URL"
                                                       type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="enable_omise" type="checkbox"
                                               name="enable_omise"
                                            {{ $gsetting->enable_omise == 1 ? 'checked' : '' }} />
                                        <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON"
                                               for="enable_omise"></label>
                                    </li>
                                    <br>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="enable_payu" type="checkbox"
                                               name="enable_payu"
                                            {{ $gsetting->enable_payu == 1 ? 'checked' : '' }} />
                                        <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON"
                                               for="enable_payu"></label>
                                    </li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="enable_moli" type="checkbox"
                                               name="enable_moli"
                                            {{ $gsetting->enable_moli == 1 ? 'checked' : '' }} />
                                        <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON"
                                               for="enable_moli"></label>
                                    </li>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="CASHFREE_APP_ID">{{ __('CASHFREE APP ID') }}<sup
                                                        class="redstar">*</sup></label>
                                                <input value="{{ env('CASHFREE_APP_ID') }}" autofocus
                                    ...
                                    <div class="row" style="{{ $gsetting->enable_skrill == 1 ? '' : 'display:none' }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ env('SKRILL_LOGO_URL') }}" autofocus
                                                       name="SKRILL_LOGO_URL"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="enable_rave" type="checkbox"
                                               name="enable_rave"
                                            {{ $gsetting->enable_rave == 1 ? 'checked' : '' }} />
                                        <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON"
                                               for="enable_rave"></label>
                                    </li>
                                    <br>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="RAVE_PUBLIC_KEY">{{ __('RAVE PUBLIC KEY') }}<sup
                                                        class="redstar">*</sup></label>
                                                <input value="{{ env('RAVE_PUBLIC_KEY') }}" autofocus
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="RAVE_SECRET_KEY">{{ __('RAVE SECRET KEY') }}<sup
                                                        class="redstar">*</sup></label>
                                                <input value="{{ env('RAVE_SECRET_KEY') }}" autofocus
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="RAVE_LOGO">{{ __('RAVE Buisness APP Logo') }}<sup
                                                        class="redstar">*</sup></label>
                                                <input value="{{ env('RAVE_LOGO') }}" autofocus name="RAVE_LOGO"
                                                       type="text"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row" style="{{ $gsetting->enable_payhere == 1 ? '' : 'display:none' }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label
                                                    for="PAYHERE_BUISNESS_APP_CODE">{{ __('PAYHERE BUISNESS APP CODE') }}
                                                    <sup
                                                        class="redstar">*</sup></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ env('PAYHERE_APP_SECRET') }}" autofocus
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <small class="text-muted"><i class="fa fa-question-circle"></i> For Test
                                                    use <b>"sandbox"</b> and for Live use <b>"live"</b></small>
                                            </div>
                                        </div>
