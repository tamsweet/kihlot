<form enctype="multipart/form-data" method="POST" action="{{ route('setting.store') }}">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <li class="tg-list-item">
                    <input class="tgl tgl-skewed" id="opp" type="checkbox"
                           name="project_logo" {{ $gsetting->logo_type == 'L' ? 'checked' : '' }}>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="exampleInputDetails">{{ __('adminstaticword.Logo') }}</label>- <p
                            class="inline info">Size: 300x90</p>
                        <br>
                        ...
                        <label for="logo">
                            ...
                            <span>{{ __('adminstaticword.ChooseaLogo') }}</span></label>
                    ...
                    <div class="well">
                        @if($setting->logo !="")
                            <div class="logo-settings">
                                <img src="{{ asset('images/logo/'.$setting->logo) }}" alt="{{ $setting->logo }}"
        ...
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="exampleInputDetails">{{ __('adminstaticword.footerlogo') }}</label>- <p
                            class="inline info">Size: 300x90</p>
                        <br>
                        <input type="file" name="footer_logo" value="{{ $setting->footer_logo }}" id="footer_logo"
                               class="{{ $errors->has('footer_logo') ? ' is-invalid' : '' }} inputfile inputfile-1"/>
                ...
                <div class="col-md-4">
                    <div class="well">
                        @if($setting->footer_logo !="")
                            <div class="logo-settings">
                                <img src="{{ asset('images/logo/'.$setting->footer_logo) }}"
                                     alt="{{ $setting->footer_logo }}" class="img-responsive">
                            </div>
                        @else
                            <div class="alert alert-danger">
                                {{ __('adminstaticword.Nologofound') }}
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="row">
                ...
                @endif
                <div class="col-md-6">
                    <label for="exampleInputDetails">{{ __('adminstaticword.Favicon') }}</label>- <p
                        class="inline info">Size: 35x35</p>
                    <br>
                    <input type="file" name="favicon" id="favi"
                           class="{{ $errors->has('favicon') ? ' is-invalid' : '' }} inputfile inputfile-1"/>
                    ...
                    <label for="favi">
                        ...
                        <span>{{ __('adminstaticword.Chooseafavicon') }}</span></label>
                </div>
                <div class="col-md-4">
                    <div class="well">
                        @if($setting->favicon !="")
                            <div class="favicon-settings">
                                <img src="{{ asset('images/favicon/'.$setting->favicon) }}"
                                     alt="{{ $setting->favicon }}" class="img-responsive">
                            </div>
                        @else
                            <div class="alert alert-danger">
        ...
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="exampleInputDetails">{{ __('adminstaticword.Preloaderlogo') }}</label>- <p
                            class="inline info">Size: 300x90</p>
                        <br>
                        <input type="file" name="preloader_logo" value="{{ $setting->preloader_logo }}"
                               id="preloader_logo"
                               class="{{ $errors->has('preloader_logo') ? ' is-invalid' : '' }} inputfile inputfile-1"/>
                ...
                <div class="col-md-4">
                    <div class="well">
                        @if($setting->preloader_logo !="")
                            <div class="favicon-settings">
                                <img src="{{ asset('images/logo/'.$setting->preloader_logo) }}"
                                     alt="{{ $setting->preloader_logo }}" class="img-responsive">
                            </div>
                        @else
                            <div class="alert alert-danger">
                                {{ __('adminstaticword.Nologofound') }}
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input value="{{ $setting->project_title }}" placeholder="Enter project title" name="project_title"
                       type="text" class="{{ $errors->has('project_title') ? ' is-invalid' : '' }} form-control">
        ...
        <div class="col-md-6">
            ...
            <input placeholder="http://localhost/" name="APP_URL" type="text"
                   class="{{ $errors->has('APP_URL') ? ' is-invalid' : '' }} form-control"
                   value="{{ $env_files['APP_URL'] }}">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <li class="tg-list-item">
                <input class="tgl tgl-skewed" id="map_enable" type="checkbox"
                       name="map_enable" {{ $gsetting->map_enable == 'map' ? 'checked' : '' }} >
        ...
        <div class="col-md-6">
            <div class="row" style="{{ $setting['map_enable'] == 'image' ? '' : 'display:none' }}" id="sec_one">
                <div class="col-md-6">
                    ...
                    <br>
                    <input type="file" name="contact_image" value="{{ $setting->contact_image }}" id="contact"
                           class="{{ $errors->has('contact_image') ? ' is-invalid' : '' }} inputfile inputfile-1">
                    ...
                    <label for="contact">
                        ...
                        <span>{{ __('adminstaticword.Chooseaimage') }}</span></label>
                </div>
                <div class="col-md-6">
                    @if($setting->contact_image !="")
                        <div class="contact-settings">
                            <img src="{{ asset('images/contact/'.$setting->contact_image) }}"
                                 alt="{{ $setting->contact_image }}" class="img-responsive">
                        </div>
                    @endif
                </div>
            </div>
    ...
    <div class="row" style="{{ $setting['map_enable'] == 'map' ? '' : 'display:none' }}" id="sec1_one">
        ...
        <div class="col-md-4">
            ...
            <input value="{{ $setting->map_long }}" name="map_long" placeholder="Enter Longitude" type="text"
                   class="{{ $errors->has('map_long') ? ' is-invalid' : '' }} form-control">
        </div>
        <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <li class="tg-list-item">
                <input class="tgl tgl-skewed" id="promo_enable" type="checkbox"
                       name="promo_enable" {{ $gsetting->promo_enable == 1 ? 'checked' : '' }} >
    ...
    <div class="row" style="{{ $setting['promo_enable'] == 1 ? '' : 'display:none' }}" id="sec2_one">
        <div class="col-md-6">
            ...
            <input value="{{ $setting->promo_text }}" name="promo_text" placeholder="Enter Promo Text" type="text"
                   class="{{ $errors->has('promo_text') ? ' is-invalid' : '' }} form-control">
        </div>
        <div class="col-md-6">
            <label for="promo_link">{{ __('adminstaticword.PromoLink') }}:</label>
            <input value="{{ $setting->promo_link }}" name="promo_link" placeholder="Enter Promo Text Link" type="text"
                   class="{{ $errors->has('promo_link') ? ' is-invalid' : '' }} form-control">
        </div>
    </div>
    <hr>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <input value="{{ $setting->chat_bubble }}" name="chat_bubble" placeholder="Enter Your Chat Bubble Link"
                   type="text" class="{{ $errors->has('chat_bubble') ? ' is-invalid' : '' }} form-control">

            <small>Facebook Bubble Chat will not work on localhost (eg. xampp & wampp)</small>
            <br>
            <small><a target="__blank" href="https://app.respond.io/">Get URL For Facebook Messenger Chat
                    Bubble</a></small>
        </div>
    ...
    <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <li class="tg-list-item">
                        <input class="tgl tgl-skewed" id="cb3" type="checkbox"
                               name="rightclick" {{ $gsetting->rightclick == '0' ? 'checked' : '' }} >
                ...
                <div class="col-md-6">
                    ...
                    <li class="tg-list-item">
                        <input class="tgl tgl-skewed" id="cb4" type="checkbox"
                               name="inspect" {{ $setting->inspect == '0' ? 'checked' : '' }} >
        ...
        <div class="col-md-3">
            ...
            <li class="tg-list-item">
                <input class="tgl tgl-skewed" id="preloader" type="checkbox"
                       name="preloader_enable" {{ $gsetting->preloader_enable == '1' ? 'checked' : '' }} >
        ...
        <div class="col-md-3">
            ...
            <br>
            <li class="tg-list-item">
                <input class="tgl tgl-skewed" id="debug" type="checkbox"
                       name="APP_DEBUG" {{ env('APP_DEBUG') == true ? "checked" : "" }} >
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-6">
                    <div>
                        ...
                        <li class="tg-list-item">
                            <input class="tgl tgl-skewed" id="welmail" type="checkbox"
                                   name="w_email_enable" {{ $gsetting->w_email_enable == '1' ? 'checked' : '' }} >
                ...
                <div class="col-md-6">
                    <div>
                        ...
                        <li class="tg-list-item">
                            <input class="tgl tgl-skewed" id="verify" type="checkbox"
                                   name="verify_enable" {{ $gsetting->verify_enable == '1' ? 'checked' : '' }} >
            ...
            <div>
                <small>(If you enable it, a welcome email will be sent to user's register email id,<br> make sure you
                    updated your mail setting in Site Setting >> Mail Settings before enable it.)</small>
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <li class="tg-list-item">
                    <input class="tgl tgl-skewed" id="instructor" type="checkbox"
                           name="instructor_enable" {{ $gsetting->instructor_enable == '1' ? 'checked' : '' }} >
            ...
            <div class="col-md-3">
                ...
                <li class="tg-list-item">
                    <input class="tgl tgl-skewed" id="category" type="checkbox"
                           name="cat_enable" {{ $gsetting->cat_enable == '1' ? 'checked' : '' }} >
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <li class="tg-list-item">
                <input class="tgl tgl-skewed" id="zoom_enable" type="checkbox"
                       name="zoom_enable" {{ $gsetting->zoom_enable == 1 ? 'checked' : '' }} >
        ...
        <div class="col-md-3">
            ...
            <li class="tg-list-item">
                <input class="tgl tgl-skewed" id="bbl_enable" type="checkbox"
                       name="bbl_enable" {{ $gsetting->bbl_enable == 1 ? 'checked' : '' }} >
        ...
        <div class="col-md-3">
            ...
            <li class="tg-list-item">
                <input class="tgl tgl-skewed" id="mobile_enable" type="checkbox"
                       name="mobile_enable" {{ $gsetting->mobile_enable == 1 ? 'checked' : '' }} >
        ...
        <div class="col-md-3">
            ...
            <li class="tg-list-item">
                <input class="tgl tgl-skewed" id="certificate_enable" type="checkbox"
                       name="certificate_enable" {{ $gsetting->certificate_enable == 1 ? 'checked' : '' }} >
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <li class="tg-list-item">
                <input class="tgl tgl-skewed" id="device_enable" type="checkbox"
                       name="device_enable" {{ $gsetting->device_control == 1 ? 'checked' : '' }} >
        ...
        <div class="col-md-3">
            ...
            <li class="tg-list-item">
                <input class="tgl tgl-skewed" id="ipblock_enable" type="checkbox"
                       name="ipblock_enable" {{ $gsetting->ipblock_enable == 1 ? 'checked' : '' }} >
        ...
        <div class="col-md-3">
            ...
            <li class="tg-list-item">
                <input class="tgl tgl-skewed" id="assignment_enable" type="checkbox"
                       name="assignment_enable" {{ $gsetting->assignment_enable == 1 ? 'checked' : '' }} >
        ...
        <div class="col-md-3">
            ...
            <li class="tg-list-item">
                <input class="tgl tgl-skewed" id="appointment_enable" type="checkbox"
                       name="appointment_enable" {{ $gsetting->appointment_enable == 1 ? 'checked' : '' }} >
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <li class="tg-list-item">
                <input class="tgl tgl-skewed" id="hide_identity" type="checkbox"
                       name="hide_identity" {{ $gsetting->hide_identity == 1 ? 'checked' : '' }} >
    ...
    <div class="box-footer">
        <button type="Submit" class="btn btn-lg col-md-3 btn-primary btn-md"><i
                class="fa fa-save"></i> {{ __('adminstaticword.Save') }}</button>
    </div>
