                        ...
                        <form action="{{ route('instructor.update') }}" method="POST">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input min="1" max="100" class="form-control" name="instructor_revenue"
                                               type="number" value="{{ $setting['instructor_revenue'] }}" id="revenue"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input min="1" max="100" class="form-control" name="admin_revenue" type="number"
                                               value="{{ 100 - $setting['instructor_revenue'] }}" id="revenue"
                                               placeholder="Enter revenue percentage"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="paytm" type="checkbox"
                                               name="paytm_enable" {{ $setting['paytm_enable'] == '1' ? 'checked' : '' }} >
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="paypal" type="checkbox"
                                               name="paypal_enable" {{ $setting['paypal_enable'] == '1' ? 'checked' : '' }} >
                                        <label class="tgl-btn" data-tg-off="Disable" data-tg-on="Enable"
                                               for="paypal"></label>
                                    </li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="bank" type="checkbox"
                                               name="bank_enable" {{ $setting['bank_enable'] == '1' ? 'checked' : '' }} >
                                        <label class="tgl-btn" data-tg-off="Disable" data-tg-on="Enable"
                                               for="bank"></label>
                                    </li>
