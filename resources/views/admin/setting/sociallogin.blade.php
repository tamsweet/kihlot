        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="{{ route('sl.fb') }}" method="POST">
                    ...
                    <input type="text" placeholder="enter client ID" class="form-control" name="FACEBOOK_CLIENT_ID"
                    ...
                    <input type="text" placeholder="https://yoursite.com/public/auth/facebook/callback"
                    ...
                    <label for=""><i class="fa fa-facebook-square"></i> {{ __('adminstaticword.EnableFacebookLogin') }}:
                    </label>
                    &nbsp;&nbsp;
                    <input {{ $gsetting->fb_login_enable==1 ? 'checked' : '' }} class="tgl tgl-skewed" name="fb_enable"
        ...
        <div class="panel panel-danger">
            ...
            <div class="panel-body">
                <form action="{{ route('sl.gl') }}" method="POST">
                    ...
                    <label for="">{{ __('adminstaticword.ClientID') }}:</label>
                    <input name="GOOGLE_CLIENT_ID" type="text" placeholder="enter client ID" class="form-control"
                    ...
                    <input type="text" placeholder="https://yoursite.com/public/auth/google/callback"
                           name="GOOGLE_CALLBACK_URL" value="{{ $env_files['GOOGLE_CALLBACK_URL'] }}"
                           class="form-control">
                    <small class="text-muted"><i class="fa fa-question-circle"></i> use callback url
                    ...
                    &nbsp;&nbsp;
                    <input name="google_enable"
                           {{ $setting->google_login_enable ==1 ? 'checked' : "" }} class="tgl tgl-skewed"
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <form action="{{ route('sl.git') }}" method="POST">
                    ...
                    <label for=""> {{ __('adminstaticword.ClientID') }}:</label>
                    <input name="GITLAB_CLIENT_ID" type="text" placeholder="enter client ID" class="form-control"
                           value="{{ $env_files['GITLAB_CLIENT_ID'] }}" input=>
                    <br>
                    ...
                    <input type="text" placeholder="https://yoursite.com/public/auth/gitlab/callback"
                           name="GITLAB_CALLBACK_URL" value="{{ $env_files['GITLAB_CALLBACK_URL'] }}"
                           class="form-control">
                    <small class="text-muted"><i class="fa fa-question-circle"></i> use callback url
                    ...
                    &nbsp;&nbsp;
                    <input name="gitlab_enable"
                           {{ $setting->gitlab_login_enable ==1 ? 'checked' : "" }} class="tgl tgl-skewed"
                           id="git_enable" type="checkbox"/>
        ...
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                <form action="{{ route('sl.amazon') }}" method="POST">
                    ...
                    <label for=""> {{ __('adminstaticword.ClientID') }}:</label>
                    <input name="AMAZON_LOGIN_ID" type="text" placeholder="enter client ID" class="form-control"
                           value="{{ $env_files['AMAZON_LOGIN_ID'] }}" input=>
                    <br>
                    ...
                    <input type="text" placeholder="https://yoursite.com/public/auth/amazon/callback"
                    ...
                    &nbsp;&nbsp;
                    <input name="amazon_enable"
                           {{ $setting->amazon_enable ==1 ? 'checked' : "" }} class="tgl tgl-skewed" id="amazon_enable"
                           type="checkbox"/>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="{{ route('sl.linkedin') }}" method="POST">
                    ...
                    <label for=""> {{ __('adminstaticword.ClientID') }}:</label>
                    <input name="LINKEDIN_CLIENT_ID" type="text" placeholder="enter client ID" class="form-control"
                           value="{{ $env_files['LINKEDIN_CLIENT_ID'] }}" input=>
                    <br>
                    ...
                    <input type="text" placeholder="https://yoursite.com/public/auth/linkedin/callback"
                    ...
                    &nbsp;&nbsp;
                    <input name="linkedin_enable"
                           {{ $setting->linkedin_enable == 1 ? 'checked' : "" }} class="tgl tgl-skewed"
                           id="linkedin_enable" type="checkbox"/>
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <form action="{{ route('sl.twitter') }}" method="POST">
                    ...
                    <label for=""> {{ __('adminstaticword.ClientID') }}:</label>
                    <input name="TWITTER_CLIENT_ID" type="text" placeholder="enter client ID" class="form-control"
                           value="{{ $env_files['TWITTER_CLIENT_ID'] }}" input=>
                    <br>
                    ...
                    <input type="text" placeholder="https://yoursite.com/auth/public/twitter/callback"
                    ...
                    &nbsp;&nbsp;
                    <input name="twitter_enable"
                           {{ $setting->twitter_enable == 1 ? 'checked' : "" }} class="tgl tgl-skewed"
                           id="twitter_enable" type="checkbox"/>
