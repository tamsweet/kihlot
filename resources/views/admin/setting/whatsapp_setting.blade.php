                                ...
                                <div class="col-md-6 col-md-offset-2">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="cb3" type="checkbox"
                                               name="wapp_enable" {{ $setting['wapp_enable'] == '1' ? 'checked' : '' }} >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="form-group">
                                        <label for="bank">{{ __('adminstaticword.WhatasppPhoneNo') }} (with country
                                            code):</label>
                                        <input value="{{ $setting['wapp_phone'] }}" name="wapp_phone" type="text"
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $setting['wapp_popup_msg'] }}" name="wapp_popup_msg"
                                               type="text" class="form-control" placeholder="PopUp Message" required
                                               autocomplete="off"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $setting['wapp_title'] }}" name="wapp_title" type="text"
                                               class="form-control" placeholder="Header Title" required
                                               autocomplete="off"/>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-skewed" id="cb4" type="checkbox"
                                                   name="wapp_position" {{ $setting['wapp_position'] == 'left' ? 'checked' : '' }} >
                                            <label class="tgl-btn" data-tg-off="Right" data-tg-on="Left"
                                                   for="cb4"></label>
                                        </li>
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="wapp_color" value="{{ $setting['wapp_color'] }}"
