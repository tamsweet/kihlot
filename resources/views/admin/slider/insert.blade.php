                        ...
                        <div class="form-group">
                            <form id="demo-form2" method="post" action="{{url('slider/')}}" data-parsley-validate
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="exampleInputSlug">{{ __('adminstaticword.SubHeading') }}:<sup
                                                class="redstar">*</sup></label>
                                        <input type="slug" class="form-control" name="sub_heading"
                                               id="exampleInputPassword1" placeholder="Please Enter Your Sub Heading">
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="row">
                                    <div class="col-md-6 display-none">
                                        <label for="exampleInputTit1e">{{ __('adminstaticword.SearchText') }}:<sup
                                                class="redstar">*</sup></label>
                                        <input type="title" class="form-control" name="search_text"
                                               id="exampleInputTitle" placeholder="Please Enter Your Search Text"
                                               value="0">
                                    </div>
                                    <div class="col-md-12">
                                        <label for="exampleInputDetails">{{ __('adminstaticword.Detail') }}:<sup
                                                class="redstar">*</sup></label>
                                        <textarea name="detail" rows="1" class="form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="exampleInputDetails">{{ __('adminstaticword.TextPosition') }}
                                            :</label>
                                        <br>
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-skewed" id="left" type="checkbox" name="left">
                                            <label class="tgl-btn" data-tg-off="Left" data-tg-on="Right"
                                                   for="left"></label>
                                        </li>
