                        ...
                        <form id="demo-form2" method="post" action="{{action('SliderfactsController@store')}}"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control icp-auto icp" type="text" name="icon"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="sub_heading" id="sub_heading"
                                           placeholder="Please Enter Your Sub Heading">
                                </div>
                            </div>
                            <br>

                            <div class="box-footer">
                                <button type="submit" value="Add Slider" class="btn btn-md col-md-2 btn-primary">
