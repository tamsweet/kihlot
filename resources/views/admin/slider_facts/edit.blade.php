                        ...
                        <form action="{{route('facts.update',$show->id)}}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input value="{{ $show->icon }}" autofocus required name="icon" type="text"
                                           class="form-control icp-auto icp" placeholder="Enter Facts Icon"/>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input value="{{ $show->heading }}" autofocus required name="heading" type="text"
                                           class="form-control" placeholder="Enter Facts Heading"/>
                                </div>

                                <div class="col-md-4">
                                    <label for="sub_heading"> {{ __('adminstaticword.SubHeading') }}<sup
                                            class="redstar">*</sup></label>
                                    <input value="{{ $show->sub_heading }}" autofocus required name="sub_heading"
