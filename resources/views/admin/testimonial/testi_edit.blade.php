                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <form id="demo-form2" method="post" action="{{url('testimonial/'.$test->id)}}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="exampleInputName">{{ __('adminstaticword.Name') }}:<sup
                                                class="redstar">*</sup></label>
                                        <input type="text" class="form-control" name="client_name"
                                               id="exampleInputTitle" value="{{$test->client_name}}">
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="file" name="image" id="image"><img
                                            src="{{ url('/images/testimonial/'.$test->image) }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-skewed" id="welmail" type="checkbox"
                                                   name="status" {{ $test->status == '1' ? 'checked' : '' }} >
