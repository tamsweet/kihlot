            ...
            <div class="box box-primary">
                ...
                <div class="panel-body">
                    <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="exampleInputDetails">{{ __('adminstaticword.Address') }}:<sup
                                        class="redstar">*</sup></label>
                                <textarea name="address" rows="1" class="form-control"
                                          placeholder="Enter your address"></textarea>
                            </div>
                            <div class="col-md-6">
                                <label for="dob">{{ __('adminstaticword.DateofBirth') }}:<sup
                                        class="redstar">*</sup></label>
                                <div class="input-group date">
                                    <div class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                    </div>
                                    <input type="text" value="{{ old('dob')}}" name="dob" required
                                           class="form-control pull-right" id="dob"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="gender">{{ __('adminstaticword.Gender') }}: <sup
                                        class="redstar">*</sup></label>

                                <br>
                                <input type="radio" name="gender" id="ch1" value="m"
                                       required> {{ __('adminstaticword.Male') }}
                            ...
                            <div class="col-md-6">
                                <label for="mobile">{{ __('adminstaticword.Password') }}: <sup class="redstar">*</sup>
                                </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input value="{{ old('pin_code')}}" placeholder="Enter your pincode" type="text"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 display-none" id="doaboxxx">
                                <label for="dob">{{ __('adminstaticword.DateofAnniversary') }}: <sup
                                        class="redstar">*</sup></label>
                                <input value="{{ old('doa')}}" name="doa" id="doa" type="text" class="form-control"
                                       placeholder="Enter your date of anniversary">
