                    ...
                    <div class="panel-body">
                        <form action="{{ route('user.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label for="mobile">{{ __('adminstaticword.Email') }}:<sup class="redstar">*</sup>
                                    </label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="address">{{ __('adminstaticword.Address') }}:<sup
                                            class="redstar">*</sup> </label>
                                    <textarea name="address" class="form-control" rows="1" required
                                              placeholder="Enter adderss" value="">{{ $user->address }}</textarea>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="radio" name="gender" id="ch1"
                                           value="m" {{ $user->gender == 'm' ? 'checked' : '' }}> {{ __('adminstaticword.Male') }}
                                    <input type="radio" name="gender" id="ch2"
                                           value="f" {{ $user->gender == 'f' ? 'checked' : '' }}> {{ __('adminstaticword.Female') }}
                                    <input type="radio" name="gender" id="ch3"
                                           value="o" {{ $user->gender == 'o' ? 'checked' : '' }}> {{ __('adminstaticword.Other') }}
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if(Auth::User()->role=="admin")
                                        <select class="form-control js-example-basic-single" name="role">
                                            <option
                                                {{ $user->role == 'user' ? 'selected' : ''}} value="user">{{ __('adminstaticword.User') }}</option>
                                            <option
                                                {{ $user->role == 'admin' ? 'selected' : ''}} value="admin">{{ __('adminstaticword.Admin') }}</option>
                                            <option
                                                {{ $user->role == 'instructor' ? 'selected' : ''}} value="instructor">{{ __('adminstaticword.Instructor') }}</option>
                                        </select>
                                    @endif
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <select id="country_id" class="form-control js-example-basic-single"
                                        ...
                                        @foreach ($countries as $coun)
                                            <option
                                                value="{{ $coun->country_id }}" {{ $user->country_id == $coun->country_id ? 'selected' : ''}}>{{ $coun->nicename }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="upload_id" class="form-control js-example-basic-single" name="state_id">
                                        ...
                                        @foreach ($states as $s)
                                            <option
                                                value="{{ $s->state_id}}" {{ $user->state_id==$s->state_id ? 'selected' : '' }}>{{ $s->name}}</option>
                                        @endforeach
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id="grand" class="form-control js-example-basic-single" name="city_id">
                                        ...
                                        @foreach ($cities as $c)
                                            <option
                                                value="{{ $c->id }}" {{ $user->city_id == $c->id ? 'selected' : ''}}>{{ $c->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input value="{{ $user->pin_code }}" placeholder="Enter Pincode" type="text"
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <li class="tg-list-item">
                                        <input class="tgl tgl-skewed" id="verified"
                                               type="checkbox" {{ $user->email_verified_at != NULL ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3">
                                    <label for="married_status">{{ __('adminstaticword.ChooseMarrigeStatus') }}
                                        : </label>
                                    <select class="form-control js-example-basic-single" id="married_status"
                                            name="married_status">
                                        <option value="none" selected disabled hidden>
                                            {{ __('adminstaticword.SelectanOption') }}
                                        </option>
                                        <option id="Unmarried"
                                                {{ $user->married_status == 'Unmarried' ? 'selected' : ''}} value="Unmarried">{{ __('adminstaticword.Unmarried') }}</option>
                                        <option id="Married"
                                                {{ $user->married_status == 'Married' ? 'selected' : ''}} value="Married">{{ __('adminstaticword.Married') }}</option>
                                        <option id="Divorced"
                                                {{ $user->married_status == 'Divorced' ? 'selected' : ''}} value="Divorced">{{ __('adminstaticword.Divorced') }}</option>
                                        <option id="Widowed"
                                                {{ $user->married_status == 'Widowed' ? 'selected' : ''}} value="Widowed">{{ __('adminstaticword.Widowed') }}</option>
                                    </select>
                                    <br>
                                </div>
                                ...
                                <div class="col-md-3 display-none" id="doaboxxx">
                                    ...
                                    <input value="{{ $user->doa }}" name="doa" id="doa" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea id="detail" name="detail" class="form-control" rows="5"
                                              placeholder="Enter your details" value="">{{ $user->detail }}</textarea>
                                </div>
                            </div>
                            <br>
