                    ...
                    <div class="panel-body">
                        ...
                        <form style="margin-top:-15px;" enctype="multipart/form-data" method="POST"
		                  ...
		                  <strong>{{ $errors->first('ad_image') }}</strong>
                            ...
                            <input class="form-control" style="display: none;" placeholder="http://" type="text"
                                   name="ad_url" id="ad_url">
		                  ...
		                  <strong>{{ $errors->first('ad_video') }}</strong>
                            ...
                            <input type="text" class="form-control" placeholder="Enter Ad Target URL: http://"
                                   name="ad_target" required>
