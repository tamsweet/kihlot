            ...
            <div class="col-lg-4">
                <div class="Login-btn txt-rgt">
                    <a href="{{ route('register') }}" class="btn btn-primary"
                       title="signup">{{ __('frontstaticword.Signup') }}</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="signin-link twitter-button">
                            <a href="{{ url('/auth/twitter') }}" target="_blank" title="twitter"
                               class="btn btn-info btm-10" title="Twitter"><i
                                    class="fab fa-twitter"></i>{{ __('frontstaticword.ContinuewithTwitter') }}</a>
                        </div>
                    @endif
                    ...
                    <form method="POST" class="signup-form" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" type="email"
                                   ...
                                   placeholder="Enter Your E-Mail" name="email" value="{{ old('email') }}" required
                                   autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <div class="forgot-password text-center btm-20"><a href="{{ 'password/reset' }}"
                        ...
                        <div class="sign-up text-center">{{ __('frontstaticword.Donothaveanaccount') }}?<a
                                href="{{ route('register') }}" title="sign-up"> {{ __('frontstaticword.Signup') }}</a>
                        </div>
