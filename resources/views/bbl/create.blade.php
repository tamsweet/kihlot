            ...
            <div class="box-body">
                <form action="{{ route('bbl.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ old('presen_name') }}" type="text" name="presen_name" class="form-control"
                               required="" placeholder="enter presenter name">
                    </div>

                    <div class="form-group">
                        <label>Meeting ID: <sup class="redstar">*</sup></label>
                        <input value="{{ old('meetingid') }}" type="text" name="meetingid" class="form-control"
                               required="" placeholder="enter meeting id">
                    </div>

                    <div class="form-group">
                        <label>Meeting Name: <sup class="redstar">*</sup></label>
                        <input value="{{ old('meetingname') }}" type="text" name="meetingname" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="5" cols="30" name="detail" class="form-control"
                                  placeholder="enter meeting detail">{{ old('detail') }}</textarea>
                    </div>

                    <div class="form-group">
                        <label>Meeting Duration: <sup class="redstar">*</sup></label>
                        <input value="{{ old('duration') }}" type="text" name="duration" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class='input-group date' id='datetimepicker1'>
                            <input value="{{ old('start_time') }}" name="start_time" type='text' class="form-control"
                                   required/>
                  ...
                  <span class="glyphicon glyphicon-calendar"></span>
                    ...
                    <div class="form-group">
                        <div class="eyeCy">
                            ...
                            <input required id="modpw" value="" type="password" name="modpw" class="form-control"
                    ...
                    <div class="form-group">
                        <div class="eyeCy">
                            <label>Attandee Password: <small class="text-muted">(<b>Tip !</b> Share your attendee
                                    password to students using social handling networks.)</small></label>

                            <input required id="attendeepw" value="" type="password" name="attendeepw"
                                   class="form-control" placeholder="enter attandee password">
