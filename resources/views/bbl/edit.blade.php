            ...
            <div class="box-body">
                <form action="{{ route('bbl.update',$meeting->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input readonly="" value="{{ $meeting->meetingid }}" type="text" name="meetingid"
                               class="form-control" required="" placeholder="enter meeting id">
                    </div>

                    <div class="form-group">
                        <label>Presenter name: <sup class="redstar">*</sup></label>
                        <input value="{{ $meeting->presen_name }}" type="text" name="presen_name" class="form-control"
                               required="" placeholder="enter presenter name">
                    </div>

                    <div class="form-group">
                        <label>Meeting Name: <sup class="redstar">*</sup></label>
                        <input value="{{ $meeting->meetingname }}" type="text" name="meetingname" class="form-control"
                               required="" placeholder="enter meeting name">
                    </div>

                    <div class="form-group">
                        <label>Meeting Duration: <sup class="redstar">*</sup></label>
                        <input value="{{ $meeting->duration }}" type="text" name="duration" class="form-control"
                               required="" placeholder="enter meeting duration eg. 40">
                        <small class="text-muted">It will be count in minutes</small>
                    </div>

                    <div class="form-group">
                        <label>Meeting Detail: <sup class="redstar">*</sup></label>
                        <textarea rows="5" cols="30" name="detail" class="form-control"
                                  placeholder="enter meeting detail">{!! $meeting->detail !!}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="eyeCy">
                            ...
                            <input value="{{ $meeting->modpw }}" required id="modpw" value="" type="password"
                    ...
                    <div class="form-group">
                        <div class="eyeCy">
                            ...
                            <input value="{{ $meeting->attendeepw }}" required id="attendeepw" value="" type="password"
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $meeting->welcomemsg }}" type="text" class="form-control" name="welcomemsg"
                               placeholder="enter welcome message">
                    </div>

                    <div class="form-group">
                        <label>Set Max Participants:</label>
                        <input value="{{ $meeting->setMaxParticipants }}" type="number" min="-1" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input {{ $meeting->setMuteOnStart == 1 ? "checked" : "" }} class="tgl tgl-skewed"
                               name="setMuteOnStart" id="setMuteOnStart" type="checkbox"/>
                        <label class="tgl-btn" data-tg-off="Disable" data-tg-on="Enable" for="setMuteOnStart"></label>
                    </div>

                    <div class="form-group">
                        <label>Allow Record:</label>
                        <input {{ $meeting->allow_record == '1' ? "checked" : "" }} class="tgl tgl-skewed"
                               name="allow_record" id="allow_record" type="checkbox"/>
