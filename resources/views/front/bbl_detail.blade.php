                        ...
                        <ul>
                            ...
                            <ul>
                                ...
                                <li><a href="#" title="about">Start
                                        At: {{ date('d-m-Y | h:i:s A',strtotime($bbl['start_time'])) }}</a></li>
                    ...
                    <div class="about-home-product">
                        <div class="video-item hidden-xs">
                            ...
                            <div class="video-device">
                                <img src="{{ Avatar::create($bbl['meetingname'])->toBase64() }}"
                        ...
                        <div class="about-home-dtl-training">
                            <div class="about-home-dtl-block btm-10">
                                ...
                                <div class="about-home-btn btm-20">
                                    <a href="" data-toggle="modal" data-target="#myModalBBL" title="join"
                                       class="btn btn-secondary"
                                       title="course">{{ __('frontstaticword.JoinMeeting') }}</a>
                                </div>

                                <div class="modal fade" id="myModalBBL" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="{{ route('bbl.api.join') }}" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input readonly="" type="text" name="meetingid"
                                                                       value="{{ $bbl['meetingid'] }}"
                                                                       class="form-control">
                                                            </div>
