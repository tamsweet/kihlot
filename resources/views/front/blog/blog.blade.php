                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4">
                                                <div class="blog-slider-img">
                                                    <a href="{{ route('blog.detail',$item->id) }}"><img
                                                            src="{{ asset('images/blog/'.$item->image) }}"
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="blog-slider-dtl">
                                                    <div
                                                        class="slider-date btm-10">{{ date('jS F Y', strtotime($item->created_at)) }}</div>
                                                    <h3 class="blog-slider-heading"><a
                                                            href="{{ route('blog.detail',$item->id) }}"
                                                            title="heading">{{ $item->heading }}</a></h3>
                                                    <p class="btm-10">{!! str_limit($item->detail, $limit = 400, $end = '...') !!}</p>
                                                    <div class="business-home-slider-btn btm-20">
                                                        <button
                                                            onclick="window.location.href='{{ route('blog.detail',$item->id) }}';"
                                                            type="button"
                            ...
                            @if($blog->status == 1 && $blog->approved == 1)
                                <div class="blog-block btm-40">
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div
                                                class="slider-date btm-10">{{ date('jS F Y', strtotime($blog->created_at)) }}</div>
                                        ...
                                        <div class="col-lg-9">
                                            <div class="block-block-dtl">
                                                <h3 class="blog-slider-heading"><a
                                                        ...
                                                        title="heading">{{ $blog->heading }}</a></h3>
