...
@section('content')
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            ...
                            <div class="careers-btn btm-40 text-center">
                                <a href="{{ $data->three_btntxt }}" class="btn btn-primary"
                                   title="careers">{{ $data->one_btntxt }}</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @if($data['three_enable'] == 1)
        <section id="careers-learn" class="careers-learn-main-block"
                 style="background-image: url('{{ asset('images/careers/'.$data->three_bg_image) }}')">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="careers-learn-video bdr-right">
                                <a href="#" title="about">
                                    <img src="{{ asset('images/careers/'.$data->three_video) }}" class="img-fluid"
                                         alt="careers">
                                </a>
                            </div>
                        </div>
