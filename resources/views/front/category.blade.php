                ...
                @foreach($category as $cat)
                    @if($cat->status == 1)
                        <div class="item categories-tab-dtl">
                            <a href="{{ route('category.page',$cat->id) }}" title="tab"><i
                                ...
                                <div class="col-md-7">
                                    <div class="categories-popularity-dtl">
                                        ...
                                        <div class="view-heading btm-10"><a
                                                href="{{ route('user.course.show',['id' => $course->id, 'slug' => $course->slug ]) }}">{{ str_limit($course->title, $limit=50)}}</a>
                                        </div>
                                        <div
                                            class="last-updated btm-10">{{ __('frontstaticword.LastUpdated') }}{{ date('jS F Y', strtotime($course->updated_at)) }}</div>
                                        <ul>
                                            <li class="rgt-5">
                                                @php
                                            ...
                                            <li class="rgt-5">
                                                <ul class="rating">
                                                    <li>
                                                        ...
                                                        @else
                                                            <div class="pull-left">
                                                                <p>{{ __('frontstaticword.NoRating') }}</p></div>
                                                        @endif
                                                    </li>
                                                </ul>
                                            </li>
                                        ...
                                        <div class="business-home-slider-btn btm-20">
                                            <a href="{{ route('user.course.show',['id' => $course->id, 'slug' => $course->slug ]) }}"
                                               type="button"
                                               class="btn btn-info">{{ __('frontstaticword.Explorecourse') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="categories-block">
                                    <ul>
                                        ...
                                        <li><a href="{{ route('subcategory.page',$cat->id) }}">{{ $cat->title }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="categories-block">
                                    <ul>
                                        ...
                                        <li><a href="{{ route('childcategory.page',$cat->id) }}">{{ $cat->title }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <section id="instructors" class="instructors-main-block btm-40">
        <div class="container">
            ...
            @if(! $instructors->isEmpty())
                <h4 class="btm-40">{{ __('frontstaticword.PopularInstructors') }}</h4>
                                ...
                                <div class="item testimonial-block text-center btm-30">
                                    <div class="instructors-img-block btm-20">
                                        @if($user['user_img'] != null || $user['user_img'] !='')
                                            <a href="{{ route('instructor.profile', $user->id) }}"
                                               title="instructor"><img
                                                    src="{{ asset('images/user_img/'.$user['user_img']) }}" alt="User"></a>
                                        @else
                                            <a href="{{ route('instructor.profile', $user->id) }}"
                                               title="instructor"><img src="{{ asset('images/default/user.jpg')}}"
                                                    ...
                                                    @foreach($course['whatlearns'] as $wl)
                                                        @if($wl->status ==1)
                                                            <div class="product-learn-dtl protip-whatlearn">
                                                                <ul>
                                                                    <li>
                                                                        <i class="fa fa-check"></i>{{ str_limit($wl['detail'], $limit = 120, $end = '...') }}
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        @endif
