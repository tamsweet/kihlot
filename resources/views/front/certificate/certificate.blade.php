            ...
            <div class="row">
                        ...
                        <div class="cirtificate-border-two">
                            ...
                            <p class="cirtificate-detail"
                               style="font-size:30px"> {{ __('frontstaticword.Thisistocertifythat') }}
                                ...
                                @else
                                    <span
                                        style="font-size:25px">{{ date('jS F Y', strtotime($order['created_at'])) }}</span>
                                @endif
                            </p>

                            <span
                                class="cirtificate-instructor">{{ ($course->user['fname']) }} {{ ($course->user['lname']) }}</span>
                            <br>
                            <span
                                class="cirtificate-one">{{ ($course->user['fname']) }} {{ ($course->user['lname']) }}, {{ __('frontstaticword.Instructor') }}</span>
                            <br>
                            <span>&</span>
                ...
                <div class="col-lg-3">
                                ...
                                <div class="rate text-right">
                                    <ul>
                                        ...
                                        @if($course->discount_price == !NULL)
                                            ...
                                            <li><a><b><i class="{{ $currency->icon }}"></i>{{ $course->discount_price }}
                                                    </b></a></li>&nbsp;
                                            <li><a><b><strike><i class="{{ $currency->icon }}"></i>{{ $course->price }}
                                                        </strike></b></a></li>
                    ...
                    <div class="download-btn btm-20">
                        <a href="{{route('cirtificate.download',$course->id)}}" target="_blank"
