                ...
                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-8">
                                        <ul>
                                            ...
                                            @if($cart->offer_price == !NULL)
                                                <li class="checkout-course-price"><b><i
                                                            class="{{ $currency->icon }}"></i>{{ $cart->offer_price }}
                                                    </b> <s><i class="{{ $currency->icon }}"></i>{{ $cart->price }}</s>
                                                </li>
                                            @else
                                                <li class="checkout-course-price"><b><i
                                                            class="{{ $currency->icon }}"></i>{{ $cart->price }}</b>
                                                </li>
                                            @endif
                                        </ul>
                                    </div>
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <div class="checkout-pricelist">
                            <ul>
                                <li><h1 class="checkout-total">{{ __('frontstaticword.Total') }}: <i
                                            class="{{ $currency->icon }}"></i>{{ $cart_total }}</h1></li>
                                <li>
                                    <div class="checkout-price"><s><i
                                                class="{{ $currency->icon }}"></i>{{ $price_total }}</s></div>
                                </li>
                                <li>
                                        ...
                                        <div class="card-header" id="headingOne">
                                            <div class="panel-title">
                                                <label for='r11'>
                                                    ...
                                                    <img src="{{ url('images/payment/paypal2.png') }}" class="img-fluid"
                                                         alt="course">
                                                </label>
                                            </div>
                                        </div>
                                ...
                                @if($gsetting->instamojo_enable == 1)
                                    <div class="card">
                                        <div class="card-header" id="headingTwo">
                                            <div class="panel-title">
                                                <label for='r12'>
                                                    <input type='radio' id='r12' name='occupation' value='Working'
                                                           required/>
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                       href="#collapseTwo"></a>
                                ...
                                @if($gsetting->stripe_enable == 1)
                                    <div class="card">
                                        <div class="card-header" id="headingThree">
                                            <div class="panel-title">
                                                <label for='r13'>
                                                    <input type='radio' id='r13' name='occupation' value='Working'
                                                           required/>
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                        ...
                                        <div id="collapseThree" class="panel-collapse collapse in">
                                            <div class="card-body">
                                                ...
                                                <div class="creditCardForm">
                                                    ...
                                                    <div class="payment">
                                                        <form accept-charset="UTF-8" action="{{route('stripe.pay')}}"
                                ...
                                @if($gsetting->enable_omise == 1 && $currency->currency == 'THB')
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingOne">
                                            <div class="panel-title">
                                                <label for='omise'>
                                                    <input type='radio' id='omise' name='occupation' value='Working'
                                                           required/>
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                       href="#omise_panel"></a>
                                ...
                                @if($gsetting->razorpay_enable == 1)
                                    <div class="card">
                                        <div class="card-header" id="headingSix">
                                            <div class="panel-title">
                                                <label for='r16'>
                                                    <input type='radio' id='r16' name='occupation' value='Working'
                                                           required/>
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                       href="#collapseSix"></a>
                                ...
                                @if($gsetting->paystack_enable == 1)
                                    <div class="card">
                                        <div class="card-header" id="headingSeven">
                                            <div class="panel-title">
                                                <label for='r14'>
                                                    <input type='radio' id='r14' name='occupation' value='Working'
                                                           required/>
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                            ...
                                                            <div class="col-md-8 col-md-offset-2">
                                                                ...
                                                                <p>
                                                                    <button class="btn btn-primary " type="submit"
                                                                            value="Pay Now">{{ __('frontstaticword.Proceed') }}</button>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </form>
                                ...
                                @if($gsetting->paytm_enable == 1)
                                    <div class="card">
                                        <div class="card-header" id="headingFour">
                                            <div class="panel-title">
                                                <label for='r17'>
                                                    <input type='radio' id='r17' name='occupation' value='Working'
                                                           required/>
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                       href="#collapseFour"></a>
                                                    <img src="{{ url('images/payment/paytm.png') }}" class="img-fluid"
                                                         alt="course">
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    @if($banktransfer->bank_enable == '1')
                                        <div class="card">
                                            <div class="card-header" id="headingEight">
                                                <div class="panel-title">
                                                    <label for='r18'>
                                                        <input type='radio' id='r18' name='occupation' value='Working'
                                                               required/>
                                                        <a data-toggle="collapse" data-parent="#accordion"
                                            ...
                                            <div id="collapseEight" class="panel-collapse collapse in">
                                                <div class="card-body">
                                                    <div class="payment-proceed-btn">
                                                        <form method="POST" action="{{ url('process/banktransfer') }}"
                                                              accept-charset="UTF-8" class="form-horizontal" role="form"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-8 col-md-offset-2">
                                                                    ...
                                                                    <br>
                                                                    <small>({{ __('frontstaticword.PleaseDocument') }}
                                                                        )</small>
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <ul class="list-group list-group-flush">
                                                                <li class="list-group-item">
                                                                    <b>{{ __('frontstaticword.Accountholdername') }}
                                                                        :</b>&nbsp;{{ $bankdetail['account_holder_name'] }}
                                                                </li>
                                                                <li class="list-group-item">
                                                                    <b>{{ __('frontstaticword.BankName') }}
                                                                        :</b>&nbsp;{{ $bankdetail['bank_name'] }}</li>
                                                                <li class="list-group-item">
                                                                    <b>{{ __('frontstaticword.BankAcccountNumber') }}
                                                                        :</b>&nbsp;{{ $bankdetail['account_number'] }}
                                                                </li>
                                                                @if(isset($bankdetail['ifcs_code']))
                                                                    <li class="list-group-item">
                                                                        <b>{{ __('frontstaticword.IFCSCode') }}</b>:&nbsp;{{ $bankdetail['ifcs_code'] }}
                                                                    </li>
                                                                @endif
                                                                @if(isset($bankdetail['swift_code']))
                                                                    <li class="list-group-item">
                                                                        <b>{{ __('frontstaticword.SwiftCode') }}</b>:&nbsp;{{ $bankdetail['swift_code'] }}
                                                                    </li>
                                                                @endif
                                                            </ul>
                                                        </div>
                                ...
                                @if($gsetting->enable_payu == 1)
                                    <div class="card">
                                        <div class="card-header" id="headingOne">
                                            <div class="panel-title">
                                                <label for='ppay'>
                                                    <input type='radio' id='ppay' name='occupation' value='Working'
                                                           required/>
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                       href="#payupay"></a>
                                ...
                                @if($gsetting->enable_cashfree == 1)
                                    <div class="card">
                                        <div class="card-header" id="headingOne">
                                            <div class="panel-title">
                                                <label for='cpay'>
                                                    <input type='radio' id='cpay' name='occupation' value='Working'
                                                           required/>
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                       href="#cashfree_pay"></a>
                                        ...
                                        <div id="rave_pay" class="panel-collapse collapse in">
                                            <div class="card-body">
                                                ...
                                                <div class="payment-proceed-btn">
                                                    ...
                                                    <form method="POST" action="{{ route('rave.pay') }}"
                                                          id="paymentForm">
                                                        {{ csrf_field() }}
                                                        <input type="hidden" name="amount"
