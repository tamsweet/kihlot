...
@if(isset($data))
    <!-- top-nav bar start-->
    <section id="comimg-soon" class="coming-soon-main-block"
             style="background-image: url('{{ asset('images/comingsoon/'.$data->bg_image) }}')">
        ...
        <div class="container-fluid">
            ...
            <div class="coming-soon-block">
                ...
                <div class="nav-bar-btn btm-20 text-center">
                    <a href="#" class="btn btn-primary" title="instructor">{{ $data->btn_text }}</a>
                </div>
            </div>
        </div>
    </section>
