                                            ...
                                            @if(!empty($progress))
                                                @if($read_count == $total_count)
                                                    <div class="about-home-btn">
                                                        <a href="{{ route('cirtificate.show', $course->id) }}"
                                        ...
                                        @else
                                            ...
                                            @foreach($questions as $question)
                                                <div class="learning-questions-dtl-block">
                                                    <div
                                                        class="learning-questions-img rgt-20">{{ str_limit($question->user->fname, $limit = 1, $end = '') }}{{ str_limit($question->user->lname, $limit = 1, $end = '') }}</div>
                                                        ...
                                                        <div class="card-header" id="headingFour{{ $announsment->id }}">
                                                            <div class="mb-0">
                                                                <button class="btn btn-link" data-toggle="collapse"
                                                                    ...
                                                                    <div
                                                                        class="learning-questions-img rgt-20">{{ str_limit($announsment->user->fname, $limit = 1, $end = '') }}{{ str_limit($announsment->user->lname, $limit = 1, $end = '') }}
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                    ...
                                                                    <div class="row">
                                                                        <div
                                                                            class="col-lg-12 offset-3 col-9 offset-sm-0">
                                                                            <div
                                                                                class="profile-heading">{{ __('frontstaticword.Announcements') }}</div>
                                                                        </div>
                            ...
                            <div class="content-course-number-block">
                                <div class="row">
                                    <div class="col-lg-3 col-sm-4">
                                        <div
                                            class="content-course-number">{{ __('frontstaticword.Bythenumbers') }}</div>
                                    </div>
                                                                    ...
                                                                    <td>
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-6">
                                                                                <div
                                                                                    class="section">{{ __('frontstaticword.Section') }}
                                                                                    : <?php echo $i;?></div>
                                                                            </div>
                                                                            <div class="col-lg-6 col-6">
                                                                                <div
                                                                                    class="section-dividation text-right">
                                                                                    @php
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-10 col-8">
                                                                                ...
                                                                                <div
                                                                                    class="profile-heading">{{ $coursechapter->chapter_name }}
                                                                                </div>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form id="demo-form2" method="post"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <label
                                                                            for="detail">{{ __('frontstaticword.Question') }}
                                                    ...
                                                    <div class="card-header" id="headingThree{{ $ques->id }}">
                                                        <div class="mb-0">
                                                            <button class="btn btn-link" data-toggle="collapse"
                                                                ...
                                                                <div
                                                                    class="learning-questions-img rgt-10">{{ str_limit($ques->user->fname, $limit = 1, $end = '') }}{{ str_limit($ques->user->lname, $limit = 1, $end = '') }}
                                                                </div>
                                                                ...
                                                                <div class="row no-gutters">
                                                                    <div class="col-lg-8 col-8">
                                                                        <div
                                                                            class="profile-heading profile-heading-two">{{ $ques->question }}
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <form id="demo-form2" method="post"
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        <label
                                                                                            for="detail">{{ __('frontstaticword.Answer') }}
                                                                                            :<sup
                                                                    ...
                                                                    <div class="answer-block">
                                                                        <div class="row no-gutters">
                                                                            <div class="col-lg-1 col-2">
                                                                                <div
                                                                                    class="learning-questions-img-two">{{ str_limit($ans->user->fname, $limit = 1, $end = '') }}{{ str_limit($ans->user->lname, $limit = 1, $end = '') }}
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <button class="btn btn-link" data-toggle="collapse"
                                                                ...
                                                                <div class="row">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class="profile-heading profile-heading-one">
                                                            ...
                                                            <table>
                                                                <td>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div
                                                                                class="assignment-delete-block text-right">
                                                                    ...
                                                                    <form id="demo-form2" method="post"
                                                                        ...
                                                                        <div class="row text-center">
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label
                                                                                        for="exampleInputDetails">{{ __('adminstaticword.ChapterName') }}
                                                                                        :<sup
                                                                                            class="redstar">*</sup></label>
                                                                                    <select style="width: 100%"
                                                                                        ...
                                                                                        @foreach($coursechapters as $c)
                                                                                            <option
                                                                                                value="{{ $c->id }}">{{ $c->chapter_name }}</option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="wrapper">
                                                                                        <label
                                                                                            for="detail">{{ __('frontstaticword.AssignmentUpload') }}
                                                                                            :<sup
                                                                                                class="redstar">*</sup></label>
                                                        ...
                                                        <ul>
                                                            ...
                                                            @if($appoint->accept == 1)
                                                                <li><a href="" data-toggle="modal"
                                                                       data-target="#myModalresponse" title="response">Response</a>
                                                                </li>
                                                                    ...
                                                                    <form id="demo-form2" method="post"
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label
                                                                                        for="title">{{ __('frontstaticword.User') }}
                                                                                        :<sup
                                                                                            class="redstar">*</sup></label>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label
                                                                                        for="title">{{ __('frontstaticword.Instructor') }}
                                                                                        :<sup
                                                                                            class="redstar">*</sup></label>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label
                                                                                        for="title">{{ __('frontstaticword.Date') }}
                                                                                        :<sup
                                                                                            class="redstar">*</sup></label>
