                    ...
                    <div class="about-home-block text-white">
                        ...
                        <ul>
                            ...
                            @if($course['language_id'] == !NULL)
                                <li><a href="#" title="about"><i
                                            class="fa fa-comment"></i></a> {{ $course->language['name'] }}</li>
                            @endif
                        </ul>
                    </div>
                </div>
                                    ...
                                    <li class="about-icon-two">
                                        <form id="demo-form2" method="post"
                                            ...
                                            <button class="wishlisht-btn" title="Remove from Wishlist" type="submit"><i
                                                    class="fa fa-heart rgt-10"></i>{{ __('frontstaticword.Wishlisted') }}
                                            </button>
                                        </form>
                                    </li>
                                @endif
                            ...
                            <div class="about-home-dtl-block btm-10">
                                        ...
                                        @else
                                            @if(isset($course->duration))
                                                @if($course->duration_type == "m")
                                                    <div
                                                        class="course-duration btm-10">{{ __('frontstaticword.EnrollDuration') }}
                                                        ...
                                                        <form id="demo-form2" method="post"
                                                            ...
                                                            <div class="box-footer">
                                                                <button type="submit" class="btn btn-primary"><i
                                                                        ...
                                                                        aria-hidden="true"></i>&nbsp;{{ __('frontstaticword.RemoveFromCart') }}
                                                                </button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                @else
                                                    <div class="about-home-btn btm-20">
                                                        <form id="demo-form2" method="post"
                                                            ...
                                                            <div class="box-footer">
                                                                <button type="submit" class="btn btn-primary"><i
                                                                        class="fa fa-cart-plus" aria-hidden="true"></i>&nbsp;{{ __('frontstaticword.AddToCart') }}
                                                                </button>
                                                            </div>
                                                        </form>
                                                    </div>
                                    ...
                                    <ul class="btm-40">
                                        @if($courseinclude->isNotEmpty())
                                            ...
                                            @foreach($course->include as $in)
                                                @if($in->status ==1)
                                                    <li>
                                                        <i class="fa {{ $in->icon }}"></i>{{ str_limit($in->detail, $limit = 50, $end = '...') }}
                                                    </li>
                                                @endif
                                            @endforeach
                                        @endif
                                ...
                                <div class="about-home-share text-center">
                                    <a href="#" data-toggle="modal" data-target="#myModalshare" title="share"><i
                                            class="fa fa-share rgt-10"></i>{{ __('frontstaticword.share') }}</a>
                                </div>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title"
                                                    id="myModalLabel">{{ __('frontstaticword.Sharethiscourse') }}</h4>
                                                    ...
                                                    <!-- The text field -->
                                                        ...
                                                        <div class="nav-search">
                                                            ...
                                                            <button onclick="myFunction()"
                                                                    class="btn btn-primary">{{ __('frontstaticword.CopyText') }}</button>
                                                        </div>
                                        ...
                                        @if($wl->status ==1)
                                            <div class="col-lg-6 col-md-6">
                                                <div class="product-learn-dtl">
                                                    <ul>
                                                        <li>
                                                            <i class="flaticon-tick-inside-circle"></i>{{ str_limit($wl['detail'], $limit = 120, $end = '...') }}
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-lg-11 col-sm-11 col-11">
                                                        <div class="featured-review-img-dtl">
                                                            <div class="review-img-name">
                                                                <span>{{ $rating->user['fname'] }}</span></div>
                                                            <div class="pull-left">
                                                                <div class="star-ratings-sprite"><span
                                                            ...
                                                            <br>
                                                            <div
                                                                class="year btm-20">{{ date('jS F Y', strtotime($rating['created_at'])) }}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        @if($help == !NULL)
                                                            <div class="helpful">
                                                                <form method="post"
                                                                    ...
                                                                    {{ csrf_field() }}
                                                                    <button type="submit"
                                                                            class="btn btn-link lft-7 rgt-10 yes-submitted">
                                                                        <i class="fa fa-check"></i> {{ __('frontstaticword.Yes') }}
                                                                    </button>
                                                                </form>
                                                            </div>
                                                        @else
                                                                    ...
                                                                    <div class="col-lg-8 col-6">
                                                                        ...
                                                                        @if($course->involvement_request == 1)
                                                                            @if($chapter->user_id != NULL)
                                                                                <a href="{{ route('instructor.profile', $chapter->user->id) }}">-
                                                                                    by {{$chapter->user['fname']}} </a>
                                                                            @endif
                                                                        @endif
                                                                    </div>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="koh-faq">
                                                                                                <div
                                                                                                    ...
                                                                                                    <span
                                                                                                        class="koh-faq-question-span"> {{ $class['title'] }} </span>
                                                                                ...
                                                                                <td>
                                                                                    @if($class->preview_url != NULL || $class->preview_video != NULL )
                                                                                        ...
                                                                                        <a href="{{ route('lightbox',$class->id) }}"
                                                                                           class="iframe"
                                                                                           style="display: block;">{{ __('frontstaticword.preview') }}</a>
                                                        ...
                                                        <div class="col-lg-7 col-md-6 col-12">
                                                            <div class="row">
                                                                <div class="col-lg-4 col-sm-4 col-5">
                                                                    <div class="course-bought-img">
                                                                        @if($item->preview_image !== NULL && $item->preview_image !== '')
                                                                            <a href="{{ route('user.course.show',['id' => $item->id, 'slug' => $item->slug ]) }}"><img
                                                                ...
                                                                <div class="col-lg-6 col-sm-8 col-7">
                                                                    ...
                                                                    <div
                                                                        class="course-update">{{ __('frontstaticword.LastUpdated') }} {{ date('jS F Y', strtotime($item['updated_at'])) }}</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                @if($item->discount_price == !NULL)
                                                                    <div class="course-currency txt-rgt">
                                                                        <ul>
                                                                            ...
                                                                            <li class="rate"><s><i
                                                                                        class="{{ $currency['icon'] }}"></i>{{ $item['price'] }}
                                                                                </s></li>
                                                                        </ul>
                                                                    </div>
                                                                @else
                                                                    <div class="course-currency txt-rgt">
                                                                        <ul>
                                                                            <li>
                                                                                <i class="{{ $currency['icon'] }}"></i>{{ $item['price'] }}
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                @endif
                                                    ...
                                                    <div class="instructor-img btm-30">
                                                        ...
                                                        @else
                                                            <img src="{{ asset('images/default/user.jpg')}}"
                                                                 class="img-fluid" alt="instructor">
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="col-lg-8 col-sm-8">
                                                    <div class="instructor-block">
                                                        <div class="instructor-name btm-10"><a
                                                                ...
                                                                title="instructor-name">{{ $course->user['fname'] }}</a>
                                                        </div>
                                                        <div
                                                            class="instructor-post btm-20">{{ __('frontstaticword.AboutInstructor') }}</div>
                                        ...
                                        <div class="student-feedback btm-40">
                                            ...
                                            <div class="student-feedback-block">
                                                ...
                                                <div class="rating">
                                                    ...
                                                    @endif
                                                    <div
                                                        class="rating-users">{{ __('frontstaticword.CourseRating') }}</div>
                                                </div>
                                                <div class="histo">
                                                ...
                                                <div class="review-block">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-10 col-12">
                                                            <form id="demo-form2" method="post"
                                                                  action="{{route('course.rating',$course->id)}}"
                                                                  data-parsley-validate
                                                                  class="form-horizontal form-label-left">
                                                                {{ csrf_field() }}
                                                                <div class="review-table top-20">
                                                                    <table class="table">
                                                                        ...
                                                                        <tr>
                                                                            <th scope="col"></th>
                                                                            <th scope="col">
                                                                                1 {{ __('frontstaticword.Star') }}</th>
                                                                            <th scope="col">
                                                                                2 {{ __('frontstaticword.Star') }}</th>
                                                                            <th scope="col">
                                                                                3 {{ __('frontstaticword.Star') }}</th>
                                                                            <th scope="col">
                                                                                4 {{ __('frontstaticword.Star') }}</th>
                                                                            <th scope="col">
                                                                                5 {{ __('frontstaticword.Star') }}</th>
                                                                        </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                        <tr>
                                                                    ...
                                                                    <div class="review-text btm-30">
                                                                        <label
                                                                            for="review">{{ __('frontstaticword.Writereview') }}
                                                                            :</label>
                                                            ...
                                                            <div class="row btm-20">
                                                                <div class="col-lg-4">
                                                                    ...
                                                                    <div class="review-img-block">
                                                                        <div
                                                                            class="review-month">{{ date('d-m-Y', strtotime($rating['created_at'])) }}</div>
                                                                        <div
                                                                            class="review-name">{{ $rating->user['fname'] }}</div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-8">
                                                                    <div class="review-rating">
                                                                        ...
                                                                        @auth
                                                                            ...
                                                                            <div
                                                                                class="review">{{ __('frontstaticword.helpful') }}
                                                                                ?
                                                                                @php
                                                                                    $help = App\ReviewHelpful::where('user_id', Auth::User()->id)->where('review_id', $rating->id)->first();
                                                                                @endphp
                                                                                ...
                                                                                <div class="modal fade"
                                                                                    ...
                                                                                    <div class="modal-dialog modal-lg"
                                                                                        ...
                                                                                        <div class="modal-content">
                                                                                            <div class="modal-header">
                                                                                                <h4 class="modal-title"
                                                                                                    id="myModalLabel">{{ __('frontstaticword.Report') }}</h4>
                                                                                                <button type="button"
                                                                                                        class="close"
                                                                                                        data-dismiss="modal"
                                                                                                        aria-label="Close">
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        class="form-group">
                                                                                                                        <label
                                                                                                                            for="title">{{ __('frontstaticword.Title') }}
                                                                                                                            :<sup
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        class="form-group">
                                                                                                                        <label
                                                                                                                            for="email">{{ __('frontstaticword.Email') }}
                                                                                                                            :<sup
                                                                                                                                class="redstar">*</sup></label>
                                                                                                                        <input
                                                                                                                            type="email"
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        class="form-group">
                                                                                                                        <label
                                                                                                                            for="detail">{{ __('frontstaticword.Detail') }}
                                                                                                                            :<sup
                                                                                                                                class="redstar">*</sup></label>
                                                                                                                        <textarea
                                                                                                                            name="detail"
                                                                    ...
                                                                    <div class="view-block">
                                                                        <div class="view-img">
                                                                            @if($rel->courses['preview_image'] !== NULL && $rel->courses['preview_image'] !== '')
                                                                                <a href="{{ route('user.course.show',['id' => $rel->course_id, 'slug' => $rel->courses->slug ]) }}"><img
                                                                        ...
                                                                        <div class="view-dtl">
                                                                            ...
                                                                            @if( $rel->courses->type == 1)
                                                                                ...
                                                                                @if($rel->courses->discount_price == !NULL)
                                                                                    <div class="rate text-right">
                                                                                        <ul>
                                                                                            <li>
                                                                                                <a><b><i class="{{ $currency['icon'] }}"></i>{{ $rel->courses['discount_price'] }}
                                                                                                    </b></a></li>&nbsp;
                                                                                            <li><a><b><strike><i
                                                                                                                class="{{ $currency['icon'] }}"></i>{{ $rel->courses['price'] }}
                                                                                                        </strike></b></a>
                                                                                            </li>
                                                                                        </ul>
                                                                                    </div>
                                                                                @else
                                                                                    <div class="rate text-right">
                                                                                        <ul>
                                                                                            <li>
                                                                                                <a><b><i class="{{ $currency['icon'] }}"></i>{{ $rel->courses['price'] }}
                                                                                                    </b></a></li>
                                                                                        </ul>
                                                                                    </div>
                                                                                @endif
                                                                            @else
                                                                                <div class="rate text-right">
                                                                                    <ul>
                                                                                        <li>
                                                                                            <a><b>{{ __('frontstaticword.Free') }}</b></a>
                                                                                        </li>
                                                                                    </ul>
                                                                                </div>
                                                                            @endif
