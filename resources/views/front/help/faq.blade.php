                    ...
                    <div class="offset-lg-3 col-lg-6">
                        <div class="form-group">
                            <input type="text" class="form-control" id="search" name="searchTerm"
                                   placeholder="Search for courses" value="{{ isset($searchTerm) ? $searchTerm : '' }}">
                ...
                <nav>
                    <div class="nav nav-tabs btm-40" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home"
                           ...
                           aria-selected="true">{{ __('frontstaticword.Students') }} </a>
                        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile"
                           role="tab" aria-controls="nav-profile"
                           aria-selected="false">{{ __('frontstaticword.Instructor') }} </a>
                    </div>
                </nav>
            </div>
                                        ...
                                        @if($faq->status == 1)
                                            <div class="col-lg-4">
                                                <a href="{{ route('faq.detail',$faq->id) }}">
                                                    <div class="categories-block help-tab">{{ $faq->title }}</div>
                                                </a>
                                            </div>
                                        @endif
                                    @endforeach
                                ...
                                <div class="categories-block help-tab-one text-center">
                                    <a href="{{ route('purchase.show') }}">
                                        <ul>
                                            ...
                                            <li class="btm-5"><span>{{ __('frontstaticword.PurchaseHistory') }}</span>
                                            </li>
                                    ...
                                    @if(Auth::check())
                                        <a href="{{route('profile.show',Auth::User()->id)}}">
                                            <ul>
                                                ...
                                                <li class="btm-5"><span>{{ __('frontstaticword.UserProfile') }}</span>
                                                </li>
                                ...
                                <div class="categories-block help-contact text-center text-white">
                                    @if(Auth::check())
                                        <a href="{{url('user_contact')}}">
                                            <ul>
                                                <li class="btm-10"><img src="{{ asset('images/icons/contact.png') }}">
                                                </li>
                                                <br>
                                                <li class="text-white">
                                                    <span>{{ __('frontstaticword.Contactus') }}</span></li>
                                        ...
                                        @if($faqs->status == 1)
                                            <div class="col-lg-4">
                                                <a href="{{ route('faqinstructor.detail',$faqs->id) }}">
                                                    <div class="categories-block help-tab">{{ $faqs->title }}</div>
                                                </a>
                                            </div>
                                        @endif
                                    @endforeach
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#myModalinstructor"
                                           title="Become An Instructor">
                                            <ul>
                                                ...
                                                <li class="btm-5">
                                                    <span>{{ __('frontstaticword.BecomeAnInstructor') }}r</span></li>
                                    ...
                                    @else
                                        <a href="{{ route('login') }}">
                                            <ul>
                                                <li class="btm-10"><img src="{{ asset('images/icons/08.png') }}"></li>
                                                <li class="btm-5">
                                                    <span>{{ __('frontstaticword.BecomeAnInstructor') }}</span></li>
                                                <li>To Become An Online Instructor</li>
                                            </ul>
                                        </a>
                                    @endif
