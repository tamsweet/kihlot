                                                ...
                                                <div class="student-view-block">
                                                    <div class="view-block">
                                                        ...
                                                        <div class="view-dtl">
                                                            ...
                                                            <p class="btm-10"><a herf="#">by {{ $c->user['fname'] }}</a>
                                                            </p>
                                                            <div class="rating">
                                                                <ul>
                                                                    <li>
                        ...
                        <ul>
                            @if($user->linkedin_url != NULL)
                                <a href="{{ $user->linkedin_url }}" target="_blank">
                                    <li><i class="fab fa-linkedin-in"></i>{{ __('frontstaticword.LinkedIn') }}</li>
                                </a>
                            @endif
                            @if($user->twitter_url != NULL)
                                <a href="{{ $user->twitter_url }}" target="_blank">
                                    <li><i class="fa fa-twitter"></i>{{ __('frontstaticword.Twitter') }}</li>
                                </a>
                            @endif
                            @if($user->fb_url != NULL)
                                <a href="{{ $user->fb_url }}" target="_blank">
                                    <li><i class="fa fa-facebook-f"></i>{{ __('frontstaticword.Facebook') }}</li>
                                </a>
                            @endif
                            @if($user->youtube_url != NULL)
                                <a href="{{ $user->youtube_url }}" target="_blank">
                                    <li><i class="fa fa-youtube"></i>{{ __('frontstaticword.Youtube') }}</li>
                                </a>
                            @endif
                        </ul>
                    </div>
