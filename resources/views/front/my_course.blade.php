                                        ...
                                        <div class="view-block">
                                            ...
                                            <div class="view-dtl" style="height: 170px">
                                                <div class="view-heading btm-10"><a
                                                        href="{{url('show/coursecontent',$enrol->courses->id)}}">{{ str_limit($enrol->courses->title, $limit = 35, $end = '...') }}</a>
                                                </div>
                                                <p class="btm-10"><a href="#">by {{ $enrol->courses->user->fname }}</a>
                                                </p>
                                                <div class="rating">
                                                    <ul>
                                                        <li>
                                                ...
                                                <div class="mycourse-progress">
                                                    ...
                                                    @if(!empty($progress))
                                                        ...
                                                        <div class="complete"><?php echo $progres; ?>
                                                            % {{ __('frontstaticword.Complete') }}</div>
                                                    @else
                                                        <div class="progress">
                                                            <div class="progress-bar progress-bar-striped bg-success"
                                                        ...
                                                        <div
                                                            class="complete">{{ __('frontstaticword.StartCourse') }}</div>
                                                    @endif
