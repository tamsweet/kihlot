                            ...
                            <div class="page-header">
                                ...
                                <div class="invoice-logo">
                                    @if($setting['logo_type'] == 'L')
                                        <img src="{{ asset('images/logo/'.$setting['logo']) }}" class="img-fluid"
                                             alt="logo">
                                    @else()
                                        <a href="{{ url('/') }}"><b>
                                ...
                                <small class="purchase-date">{{ __('frontstaticword.Puchasedon') }}
                                    : {{ date('jS F Y', strtotime($orders['created_at'])) }}</small>
                            </div>
                        </div>
                        <!-- /.col -->
                    </div>
                    ...
                    <div class="view-order">
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col">
                                ...
                                <b>{{ __('frontstaticword.Enrollon') }}
                                    :</b> {{ date('jS F Y', strtotime($orders['created_at'])) }}</br>
                                <b>
                                    @if($orders->enroll_expire != NULL)
                                        {{ __('frontstaticword.EnrollEnd') }}
                                        :</b> {{ date('jS F Y', strtotime($orders['enroll_expire'])) }}</br>
                                @endif
                            </div>
                            <!-- /.col -->
                        </div>
                            ...
                            <tr>
                                ...
                                @if($orders->coupon_discount != 0)
                                    <td class="text-center">
                                        (-)&nbsp;<i
                                            class="{{ $orders['currency_icon'] }}"></i>{{ $orders['coupon_discount'] }}
                                    </td>
                                @endif
