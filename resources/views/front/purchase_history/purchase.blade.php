                            ...
                            <tr>
                                ...
                                <td>
                                    @if($order->coupon_discount == !NULL)
                                        <div class="purchase-text"><b><i
                                                    class="fa {{ $order->currency_icon }}"></i>{{ $order->total_amount - $order->coupon_discount }}
                                            </b></div>
                                    @else
                                        <div class="purchase-text"><b><i
                                ...
                                <td>
                                    <div class="invoice-btn">
                                        ...
                                        <a href="{{route('invoice.show',$order->id)}}"
                                           class="btn btn-secondary">{{ __('frontstaticword.Invoice') }}</a>
