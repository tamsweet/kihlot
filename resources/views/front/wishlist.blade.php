                                ...
                                <div class="view-block">
                                    <div class="view-img">
                                        @if($wish->courses['preview_image'] !== NULL && $wish->courses['preview_image'] !== '')
                                            <a href="{{ route('user.course.show',['id' => $wish->courses->id, 'slug' => $wish->courses->slug ]) }}"><img
                                            ...
                                            <div class="rate text-right">
                                                <ul>
                                                    ...
                                                    @if($wish->courses->discount_price == !NULL)
                                                        ...
                                                        <li class="rate-r"><s><i
                                                                    class="{{ $currency->icon }}"></i>{{ $wish->courses->price }}
                                                            </s></li>
                                                        <li>
                                                            <b><i class="{{ $currency->icon }}"></i>{{ $wish->courses->discount_price }}
                                                            </b></li>
                                                    @else
                                                        <li>
                                                            <b><i class="{{ $currency->icon }}"></i>{{ $wish->courses->price }}
                                                            </b></li>
                                                    @endif
                                                </ul>
                                            </div>
                                        ...
                                        <div class="col-md-6 col-6">
                                            <div class="wishlist-btn txt-rgt">
                                                <form method="post" action="{{url('delete/wishlist', $wish->id)}}"
                                                    ...
                                                    <button type="submit" class="btn btn-primary "
                                                            title="Remove From Wishlist"><i class="fa fa-trash"></i>
                                                    </button>
                                                </form>
                                            </div>
                                        </div>
            ...
            <div class="container">
                ...
                <div class="recommendation-btn text-white text-center">
                    <a href="{{ url('/') }}" class="btn btn-primary"
                       title="search"><b>{{ __('frontstaticword.Browse') }}</b></a>
                </div>
            </div>
        </section>
    @endif
