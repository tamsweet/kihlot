        ...
        <div class="card-body" id="stepbox">
            <form autocomplete="off" action="{{ route('store.server') }}" id="step1form" method="POST"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        ...
                                        <i class="text-success fa fa-times-circle"></i> Require php version is 7.1 or
                                        above
                                        @php
                ...
                @if(!in_array(0, $servercheck))
                    <button class="float-right step1btn btn btn-primary" type="submit">Continue to Installation...
                    </button>
                @else
                    <p class="pull-right text-danger"><b>Some extension are missing. Contact your host provider for
                            enable it.</b></p>
                @endif
            </form>
        </div>
