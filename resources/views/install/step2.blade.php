...
<div class="container">
    <div class="card">
        ...
        <div class="card-body" id="stepbox">
            <form autocomplete="off" action="{{ route('store.step2') }}" id="step2form" method="POST"
                  class="database-validation" novalidate>
                @csrf
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input name="DB_DATABASE" type="text" class="form-control" id="DB_DATABASE"
                               placeholder="db_name" value="{{ env('DB_DATABASE') }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input name="DB_USERNAME" type="text" class="form-control" id="DB_USERNAME" placeholder="root"
                               value="{{ env('DB_USERNAME') }}" required>
                    ...
                    <div class="eyeCy col-md-6 mb-3">
                        ...
                        <input name="DB_PASSWORD" type="password" class="form-control" id="validationCustom05"
