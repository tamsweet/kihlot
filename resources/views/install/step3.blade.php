...
<div class="container">
    <div class="card">
        ...
        <div class="card-body" id="stepbox">
            <form autocomplete="off" enctype="multipart/form-data" action="{{ route('store.step3') }}" id="step3form"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input name="project_name" type="text" class="form-control" id="validationCustom01"
                               placeholder="Project_Name" value="" required>
