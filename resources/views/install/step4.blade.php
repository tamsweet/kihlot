...
<div class="container">
    <div class="card">
        ...
        <div class="card-body" id="stepbox">
            <form autocomplete="off" enctype="multipart/form-data" action="{{ route('store.step4') }}" id="step4form"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="fname" type="text" class="form-control" id="validationCustom01"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="lname" type="text" class="form-control" id="validationCustom01"
                    ...
                    <div class="eyeCy col-md-6 mb-3">
                        ...
                        <input type="password" class="form-control" placeholder="*****" required id="validationCustom04"
                               name="password">
                        <span toggle="#validationCustom04"
                    ...
                    <div class="eyeCy col-md-6 mb-3">
                        ...
                        <input type="password" class="form-control" placeholder="*****" required id="validationCustom05"
                               name="password_confirmation">
                        <span toggle="#validationCustom05"
                              class="eye fa fa-fw fa-eye field-icon toggle-password"></span>
                        <div class="invalid-feedback">
