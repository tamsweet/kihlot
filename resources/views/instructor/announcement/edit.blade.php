                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <form id="demo-form" method="post" action="{{url('instructor/announcement/'.$announs->id)}}"
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <label for="exampleInputTit1e">{{ __('adminstaticword.Announsment') }}:<span
                                                class="redstar">*</span></label>
                                        <textarea name="announsment" rows="3" class="form-control"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <li class="tg-list-item">
                                            <input class="tgl tgl-skewed" id="cb77"
                                                   type="checkbox" {{ $announs->status==1 ? 'checked' : '' }}>
