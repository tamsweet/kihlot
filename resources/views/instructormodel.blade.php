                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="dob" id="title"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="gender" required>
                                                    ...
                                                    <option
                                                        value="Male" {{ Auth::User()->gender == 'm' ? 'selected' : ''}}>
                                                        Male
                                                    </option>
                                                    <option
                                                        value="Female" {{ Auth::User()->gender == 'f' ? 'selected' : ''}}>
                                                        Female
                                                    </option>
                                                    <option
                                                        value="Other" {{ Auth::User()->gender == 'o' ? 'selected' : ''}}>
                                                        Other
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" value="{{Auth::User()->email}}" class="form-control"
                                                       name="email" id="title" placeholder="Please Enter Email"
                                                       value="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="mobile" id="contact"
                                                       placeholder="Please Enter Contact No." value="" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="detail" rows="5" class="form-control" placeholder=""
                                                          required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
