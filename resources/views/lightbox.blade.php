...
<ul id="courseplaylist" class="display-none">
    <li data-source="courseplaycontent{{ $class->id }}" data-playlist-name="{{ $class->coursechapters->chapter_name }}"
        data-thumbnail-path="{{ url('images/course/'.$class->courses->preview_image) }}">
        <p class="minimalDarkCategoriesTitle"><span
                class="minimialDarkBold">Title: </span>{{ $class->coursechapters->chapter_name }}</p>
        <p class="minimalDarkCategoriesType"><span
                class="minimialDarkBold">Category: </span>{{ $class->courses->category->title }}</p>
        <p class="minimalDarkCategoriesDescription"><span
                class="minimialDarkBold">Course: </span>{{ strip_tags($class->courses->title) }}</p>
    </li>
</ul>
        ...
        @if($class->status == '1')
            <li
                ...
                <div data-video-short-description="">
                    ...
                    <p class="minimalDarkCategoriesDescription"><span
                            class="minimialDarkBold">Course: </span>{{ $class->courses->title }}</p>
                </div>
