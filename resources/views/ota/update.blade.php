...
<div class="container">
                ...
                <blockquote class="text-justify text-dark font-weight-normal">
                    ...
                    <ul>
                        ...
                        <li><b>Q.</b> Will This Update affect my customization eg. in <b>CSS,JS or in Core code</b>
                            ?
                            <br>
                            <b>Answer:</b> Yes it will affect your changes if you did changes in code files <br> If you
                            customize <B>CSS or JS</B> using <b>Admin -> Custom Style Setting</b> Than all your change
                            will not affect else it will affect.
                        </li>
                    </ul>
    ...
    <p class="text-center m-3 text-white">&copy;{{ date('Y') }} | {{ __('eclass Updater') }} | <a class="text-white"
                                                                                                  href="http://mediacity.co.in">{{ __('Mediacity') }}</a>
    </p>
</div>
