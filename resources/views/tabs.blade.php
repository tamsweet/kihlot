                    ...
                    <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-interactive="false"
                        ...
                        <div class="view-block">
                            ...
                            <div class="view-dtl">
                                ...
                                <p class="btm-10"><a herf="#">{{ __('frontstaticword.by') }} {{ $c->user['fname'] }}</a>
                                </p>
                                <div class="rating">
                                    <ul>
                                        <li>
                                ...
                                @if( $c->type == 1)
                                    <div class="rate text-right">
                                        <ul>
                                            ...
                                            @else
                                                <li><a><b><i class="{{ $currency['icon'] }}"></i>{{ $c->price }}</b></a>
                                                </li>
                                            @endif
                        ...
                        <div class="prime-description-under-block">
                            <div class="prime-description-under-block">
                                ...
                                <div class="protip-img">
                                    @if($c['preview_image'] !== NULL && $c['preview_image'] !== '')
                                        <a href="{{ route('user.course.show',['id' => $c->id, 'slug' => $c->slug ]) }}"><img
                                                src="{{ asset('images/course/'.$c['preview_image']) }}" alt="student"
                                                class="img-fluid">
                                        </a>
                                    @else
                                        <a href="{{ route('user.course.show',['id' => $c->id, 'slug' => $c->slug ]) }}"><img
                                                src="{{ Avatar::create($c->title)->toBase64() }}" alt="student"
                                                class="img-fluid">
                                        </a>
                                    @endif
                                </div>
                                        ...
                                        @if( $c->type == 1)
                                            <div class="rate text-right">
                                                <ul>
                                                    ...
                                                    @else
                                                        <li><a><b><i class="{{ $currency['icon'] }}"></i>{{ $c->price }}
                                                                </b></a></li>
                                                    @endif
                                                    ...
                                                    @if(Auth::User()->role == "admin")
                                                        <div class="protip-btn">
                                                            <a href="{{url('show/coursecontent',$c->id)}}"
                                                               class="btn btn-secondary" title="course">Go To Course</a>
                                                        </div>
                                                    @else
                                                        @php
                                        ...
                                        <li class="protip-wish-btn-two">
                                            <form id="demo-form2" method="post"
                                                ...
                                                <button class="wishlisht-btn" title="Remove from Wishlist"
                                                        type="submit"><i class="fa fa-heart rgt-10"></i></button>
                                            </form>
                                        </li>
                                    @endif
                                @else
