            ...
            <div class="box-body">
                <form autocomplete="off" action="{{ route('zoom.store') }}" method="POST">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="recurring_meeting">Recurring Metting (with no fixed
                            time) </label>
                        <br>
                    </div>
                    <br>
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-muted"><i class="fa fa-question-circle"></i> Set to None if you want to use
                            your account timezone.</small>
                    </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input name="registrants_email_notification" type="checkbox"
