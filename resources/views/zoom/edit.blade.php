        ...
        <div class="box">
            ...
            <div class="box-header with-border">
                <div class="box-title">
                    ...
                    <h5>Meeting Type : @if($response['type'] == '2') Scheduled Meeting @elseif($response['type'] == '3')
                ...
                <form autocomplete="off" action="{{ route('zoom.update',$response['id']) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <li class="tg-list-item">
                            <input class="tgl tgl-skewed" id="link_by" type="checkbox"
                                   name="link_by" {{ $meeting['link_by'] == 'course' ? 'checked' : '' }}>
                    ...
                    <div class="form-group" style="{{ $meeting['link_by'] == 'course' ? '' : 'display:none' }}"
                         id="sec1_one">
                        ...
                        <select name="course_id" id="course_id" class="form-control js-example-basic-single">
                            ...
                            @foreach($course as $caat)
                                <option
                                    {{ $meeting['course_id'] == $caat->id ? 'selected' : "" }} value="{{ $caat->id }}">{{ $caat->title }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $response['topic'] }}" type="text" name="topic" placeholder="Ex. My Meeting"
                    ...
                    @if($response['type'] == '2' && $response['type'] == '8')
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ $response['duration'] }}" placeholder="enter in mins eg 60" type="number"
                                   min="1" name="duration" class="form-control" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="agenda" class="form-control" rows="3" required placeholder="Meeting Agenda"
                                  value="">{{ $response['agenda'] }}</textarea>
                    </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input
                                    {{ $response['settings']['host_video'] == true ? "checked" : "" }} name="host_video"
                            ...
                            <div class="custom-control custom-checkbox">
                                <input
                                    {{ $response['settings']['participant_video'] == true ? "checked" : "" }} name="participant_video"
                                    type="checkbox" class="custom-control-input" id="participant_video">
                                <label class="custom-control-label" for="participant_video">Enable Participant
                                    Video</label>
                            </div>

                            <div class="custom-control custom-checkbox">
                                <input
                                    {{ $response['settings']['join_before_host'] == true ? "checked" : "" }} name="join_before_host"
                                    type="checkbox" class="custom-control-input" id="join_before_host">
                                <label class="custom-control-label" for="join_before_host">Join before host?</label>
                            </div>

                            <div class="custom-control custom-checkbox">
                                <input
                                    {{ $response['settings']['mute_upon_entry'] == true ? "checked" : "" }} name="mute_upon_entry"
                                    type="checkbox" class="custom-control-input" id="mute_upon_entry">
                                <label class="custom-control-label" for="mute_upon_entry">Mute Upon Entry?</label>
                            </div>

                            <div class="custom-control custom-checkbox">
                                <input
                                    {{ $response['settings']['registrants_email_notification'] == true ? "checked" : "" }} name="registrants_email_notification"
                                    type="checkbox" class="custom-control-input" id="registrants_email_notification">
                                <label class="custom-control-label" for="registrants_email_notification">Registrants
