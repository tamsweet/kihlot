                            ...
                            @foreach($meetings as $meeting)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p><b>{{ __('adminstaticword.MeetingTopic') }}
                                                :</b> {{ $meeting['meeting_title'] }}</p>
                                        <p><b>{{ __('adminstaticword.StartTime') }}
                                                :</b> {{ date('d-m-Y | h:i:s A',strtotime($meeting['start_time'])) }}
                                        </p>

                                        @if(isset($meeting->course_id))

                                            <p><b>{{ __('adminstaticword.Meetingoncourse') }}
                                                    :</b> {{ $meeting->courses['title'] }}</p>
                                    ...
                                    <td>
                                        <a href="{{ $meeting->zoom_url }}" target="_blank" class="btn btn-primary">Join
                                            Meeting</a>
                                    </td>
